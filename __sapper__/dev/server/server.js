...
async function get$3(req, res, next) {
	// the `slug` parameter is available because
	// this file is called [slug].json.js
	const { slug } = req.params;
	const {db} = await init();
...
const Performance = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"sports/swimming/swimming"}"><p>Swimming</p>
	...
	pages: [
...

		{
			...
			parts: [
				null,
				null,
				{ name: "sports_swimming_swimming", file: "sports/swimming/swimming.svelte", component: Swimming }
			]
		},
