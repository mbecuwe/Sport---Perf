...
<p>${escape(addCustomSport())}</p>

<p>${escape(test("yes"))}</p>

${validate_component(Chart_1, "ChartJS").$$render($$result, {}, {}, {})}`;
});
...
const Performance = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<ul><li><a href="${"sports/cycling/cycling"}">Cycling</a></li>
        
		<li><a href="${"sports/running/running"}">Running</a></li>
		
        <li><a href="${"sports/workout/workout"}">Work-out</a></li></ul>`;
});
