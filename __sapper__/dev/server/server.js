...
const New_session = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"text-center p-10"}"><h1>Click sports to add new sessions</h1></div>




<div class="${"flex content-start flex-wrap h-48"}"><div class="${"w-1/2 p-2"}"><div class="${"text-center  p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"new_sessions/cycling/new_cycling"}"><p class="${" font-bold pb-2"}">Cycling</p>
			<img src="${"cycling.jpg"}" alt="${"cycling"}"></a>`
	})}</div></div>

  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"new_sessions/running/new_running"}"><p class="${" font-bold pb-2"}">Running</p>
			<img src="${"running.jpg"}" alt="${"running"}"></a>`
	})}</div></div>

  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"new_sessions/workout/new_workout"}"><p class="${" font-bold pb-2"}">Work-out</p>
		<img src="${"workout.jpg"}" alt="${"workout"}"></a>`
	})}</div></div>
  
  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"new_sessions/swimming/new_swimming"}"><p class="${" font-bold pb-2"}">Swimming</p>
		<img src="${"swimming.jpg"}" alt="${"swimming"}"></a>`
	})}</div></div></div>
...
const Performance = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"text-center p-10"}"><h1>Click on sports to see your performance !</h1></div>



<div class="${"flex content-start flex-wrap h-48"}"><div class="${"w-1/2 p-2"}"><div class="${"text-center  p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"sports/cycling/cycling"}"><p class="${" font-bold pb-2"}">Cycling</p>
			<img src="${"cycling.jpg"}" alt="${"cycling"}"></a>`
	})}</div></div>

  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"sports/running/running"}"><p class="${" font-bold pb-2"}">Running</p>
			<img src="${"running.jpg"}" alt="${"running"}"></a>`
	})}</div></div>

  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"sports/workout/workout"}"><p class="${" font-bold pb-2"}">Work-out</p>
		<img src="${"workout.jpg"}" alt="${"workout"}"></a>`
	})}</div></div>
  
  <div class="${"w-1/2 p-2"}"><div class="${" text-center p-2"}">${validate_component(Box, "Box").$$render($$result, {}, {}, {
		default: () => `<a href="${"sports/swimming/swimming"}"><p class="${" font-bold pb-2"}">Swimming</p>
		<img src="${"swimming.jpg"}" alt="${"swimming"}"></a>`
	})}</div></div></div>`;
});
...
const Tutorial = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<body class="${"bg-blue-100 w-screen h-screen m-8"}"><div class="${"m-8"}"><div class="${"flex justify-center"}"><h1 class="${"font-bold text-4xl text-blue-800"}">Tutorial</h1></div>
            <div class="${" mt-12 items-center justify-center"}"><div class="${"container mx-auto py-16"}"><p class="${"flex justify-center mb-6 text-gray-500 text-xl"}">Where it all starts</p>
                    <div class="${"flex justify-center pb-6 mx-auto"}"><iframe width="${"560"}" height="${"315"}" src="${"https://www.youtube.com/embed/6uG9lsx-EMo"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen controls autoplay></iframe></div></div>
                <div class="${"container mx-auto py-16"}"><p class="${"flex justify-center mb-6 text-gray-500 text-xl"}">How to use the application</p>
                    <div class="${"flex justify-center pb-6 mx-auto"}"><iframe width="${"560"}" height="${"315"}" src="${"https://www.youtube.com/embed/6uG9lsx-EMo"}" frameborder="${"0"}" allow="${"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"}" allowfullscreen controls autoplay></iframe></div></div></div></div></body>`;
});
...
const Swimming = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"flex h-48"}"><div class="${"flex-initial w-2/3 p-2"}"><div class="${"text-center p-2 text-2xl font-semibold bg-gray-100"}">Swimming Performance
    </div></div>
  <div class="${"flex-initial w-1/3 p-2"}"><div class="${" text-right p-2"}"><img src="${"swimming.jpg"}" alt="${"swimming"}"></div></div></div>


<div class="${"px-10"}">Your last sessions took place on: 
    <lu>${each(get_last_nb_sessions(3, list_date), date => `<li>${escape(date)}</li>`)}</lu></div>


<div class="${"p-10"}"><table class="${"table-auto text-center "}"><thead><tr><th class="${"px-4 py-2"}">Metrics</th>
...
<div class="${"px-10 py-5"}">Get the data available in table

    <div class="${"py-5"}"><table class="${"table-auto text-center "}"><thead><tr><th class="${"px-4 py-2"}">Date</th>
...
<div class="${"px-10 py-5"}"><h3>See your evolution in this chart:</h3>
     ${validate_component(Swimming_charts, "Charts").$$render($$result, { data }, {}, {})}</div>`;
});
...
const Cycling = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"flex h-48"}"><div class="${"flex-initial w-2/3 p-2"}"><div class="${"text-center p-2 text-2xl font-semibold bg-gray-100"}">Cycling Performance
    </div></div>
  <div class="${"flex-initial w-1/3 p-2"}"><div class="${" text-right p-2"}"><img src="${"cycling.jpg"}" alt="${"cycling"}"></div></div></div>


<div class="${"px-10"}">Your last sessions took place on: 
    <lu>${each(get_last_nb_sessions$1(3, list_date), date => `<li>${escape(date)}</li>`)}</lu></div>
...
<div class="${"px-10 py-5"}"><h3>See your evolution in this chart:</h3>
     ${validate_component(Cycling_charts, "Charts").$$render($$result, { data }, {}, {})}</div>`;
});
...
const Running = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"flex h-48"}"><div class="${"flex-initial w-2/3 p-2"}"><div class="${"text-center p-2 text-2xl font-semibold bg-gray-100"}">Running Performance
    </div></div>
  <div class="${"flex-initial w-1/3 p-2"}"><div class="${" text-right p-2"}"><img src="${"running.jpg"}" alt="${"running"}"></div></div></div>


<div class="${"px-10"}">Your last sessions took place on: 
    <lu>${each(get_last_nb_sessions$2(3, list_date), date => `<li>${escape(date)}</li>`)}</lu></div>
...
<div class="${"px-10 py-5"}"><h3>See your evolution in this chart:</h3>
     ${validate_component(Running_charts, "Charts").$$render($$result, { data }, {}, {})}</div>`;
});
...
const Workout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"flex h-48"}"><div class="${"flex-initial w-2/3 p-2"}"><div class="${"text-center p-2 text-2xl font-semibold bg-gray-100"}">Workout Performance
    </div></div>
  <div class="${"flex-initial w-1/3 p-2"}"><div class="${" text-right p-2"}"><img src="${"workout.jpg"}" alt="${"workout"}"></div></div></div>
...
<div class="${"text-2xl font-semibold "}">Legs
</div>

<div class="${"px-10 py-5"}">Get the data available in table
    <div class="${"py-5"}"><table class="${"table-auto text-center "}"><thead><tr><th class="${"px-2 py-2"}"></th>
...
<div class="${"p-7"}">Your last session was ${escape(leg_global_indicator)} % of the average of the sessions where you worked on legs
</div>

${validate_component(Workoutlegs_radar, "ChartsRadarLeg").$$render($$result, { data_leg_radar }, {}, {})} 

<div class="${"text-2xl font-semibold "}">Push-Ups
</div>
...
<div class="${"p-7"}">Your last session was ${escape(pushups_global_indicator)} % of the average of the sessions where you worked on pushups
</div>
${validate_component(Workoutpushups_radar, "ChartsRadarPushUps").$$render($$result, { data_pushups_radar }, {}, {})} 

<div class="${" text-2xl font-semibold "}">Abdominals</div>
...
<div class="${"p-7"}">Your last session was ${escape(abdominal_global_indicator)} % of the average of the sessions where you worked on abdominals
</div>
${validate_component(Workoutabdo_radar, "ChartsRadarAbdominals").$$render($$result, { data_abdominal_radar }, {}, {})} 

<div class="${"text-2xl font-semibold "}">Others
</div>
...
<div class="${"p-7"}">Your last session was ${escape(others_global_indicator)} % of the average of the sessions where you worked on others
</div>
${validate_component(Workoutothers_radar, "ChartsRadarOthers").$$render($$result, { data_others_radar }, {}, {})}`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-1dbd5up"}"><ul class="${"svelte-1dbd5up"}"><li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}" class="${"svelte-1dbd5up"}">home</a></li>
		...
		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "new_session" ? "page" : undefined, 0)} href="${"new_session"}" class="${"svelte-1dbd5up"}">new session</a></li>

		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "performance" ? "page" : undefined, 0)} href="${"performance"}" class="${"svelte-1dbd5up"}">performance</a></li>
		...
		<li class="${"svelte-1dbd5up"}"><a${add_attribute("aria-current", segment === "tutorial" ? "page" : undefined, 0)} href="${"tutorial"}" class="${"svelte-1dbd5up"}">tutorial</a></li>
	...
	pages: [
...

		{
			...
			parts: [
				null,
				null,
				{ name: "new_sessions_swimming_new_swimming", file: "new_sessions/swimming/new_swimming.svelte", component: New_swimming, preload: preload }
			]
		},

		{
			...
			parts: [
				null,
				null,
				{ name: "new_sessions_cycling_new_cycling", file: "new_sessions/cycling/new_cycling.svelte", component: New_cycling, preload: preload$1 }
			]
		},

		{
			...
			parts: [
				null,
				null,
				{ name: "new_sessions_running_new_running", file: "new_sessions/running/new_running.svelte", component: New_running, preload: preload$2 }
			]
		},

		{
			...
			parts: [
				null,
				null,
				{ name: "new_sessions_workout_new_workout", file: "new_sessions/workout/new_workout.svelte", component: New_workout, preload: preload$3 }
			]
		},
...

		{
			...
			parts: [
				null,
				null,
				{ name: "sports_swimming_swimming", file: "sports/swimming/swimming.svelte", component: Swimming, preload: preload$4 }
			]
		},
...

		{
			...
			parts: [
				null,
				null,
				{ name: "sports_cycling_cycling", file: "sports/cycling/cycling.svelte", component: Cycling, preload: preload$5 }
			]
		},
...

		{
			...
			parts: [
				null,
				null,
				{ name: "sports_running_running", file: "sports/running/running.svelte", component: Running, preload: preload$6 }
			]
		},
...

		{
			...
			parts: [
				null,
				null,
				{ name: "sports_workout_workout", file: "sports/workout/workout.svelte", component: Workout, preload: preload$7 }
			]
		},
