...
<div class="${""}"><div class="${"mb-6 shadow "}"><img src="${"index.jpg"}" alt="${"work harder sign"}" class="${"antialiased bg-gray-600 object-cover h-48 w-full shadow rounded-md opacity-75"}"></div>
    ...
    <div class="${"flex justify-center mb-8"}"><h1 class="${"text-4xl text-center text-blue-700 font-semibold tracking-widest"}">Welcome to the Sport Performance Assistant !</h1></div>
...
<div class="${"pt-8"}"><h1 class="${"text-blue-800"}">What&#39;s next? 
  ...
  <div class="${"flex-initial w-1/3 p-4"}"><h1 class="${"text-blue-800"}">Calendar of your last sport sessions : 
    </h1><p class="${"flex justify-center"}"><lu>${each([1, 2, 3, 4, 5], i => `<li class="${"p-2"}">${escape(list_date[list_date.length - i])} / ${escape(list_sport[list_sport.length - i])}</li>`)}</lu></p></div></div></div>
...
const New_session = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<body class="${""}"><div class="${"bg-blue-100"}"><div class="${"mb-6 shadow "}"><img src="${"workout_3.jpg"}" alt="${"work harder sign"}" class="${"antialiased bg-gray-600 object-cover h-48 w-full shadow rounded-md opacity-75"}"></div>
	<div class="${""}"><div class="${""}"><div class="${"flex justify-center mb-8"}"><h1 class="${"text-4xl text-blue-700 font-semibold tracking-widest"}">Add a new Session</h1></div>
...
const Performance = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<body class="${""}"><div class="${"mb-6 shadow "}"><img src="${"performance.jpg"}" alt="${"work harder sign"}" class="${"antialiased bg-gray-600 object-cover h-48 w-full shadow rounded-md opacity-75"}"></div>

	<div class="${""}"><div class="${""}"><div class="${"flex justify-center mb-8"}"><h1 class="${"text-4xl text-blue-700 font-semibold tracking-widest"}">See your Performance</h1></div>
	...
	<div class="${"md:flex justify-center"}"><div class="${" text-center mx-4 md:w-1/2"}"><p class="${"font-semibold tracking-wider text-xl text-blue-700 pb-6"}">Work-out</p>
		...
		<div class="${" text-center mx-4  md:w-1/2 "}"><p class="${"font-semibold tracking-wider text-xl text-blue-700 pb-6"}">Swimming</p>
			<div class="${"hover:shadow-2xl hover:border-blue-800"}"><a href="${"sports/swimming/swimming"}"><img src="${"swimming2.jpg"}" alt="${"swimming"}" class="${"rounded-lg"}"></a></div></div></div></div></div></body>
...
${validate_component(Workoutabdo_radar, "ChartsRadarAbdominals").$$render($$result, { data_abdominal_radar }, {}, {})}</div>
    ...
    <div class="${"mt-8  m-12  "}"><caption class="${"text-center container mx-auto font-semibold mb-6 mt-8 text-xl italic text-blue-700"}">Performance Radar Chart</caption>
            ${validate_component(Workoutothers_radar, "ChartsRadarOthers").$$render($$result, { data_others_radar }, {}, {})}</div></div>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav><div class="${"flex justify-between items-center py-0 bg-blue-900"}"><div class="${"flex-shrink-0 ml-10 cursor-pointer"}"><i class="${"fas fa-drafting-compass fa-2x text-orange-500"}"></i>
