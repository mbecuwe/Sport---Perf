import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.5a7864b1.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.98b46810.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th0, file, 82, 8, 1677);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 83, 8, 1720);
			attr_dev(th2, "class", "px-4 py-2");
			add_location(th2, file, 84, 8, 1761);
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 85, 8, 1825);
			add_location(tr0, file, 81, 8, 1664);
			add_location(thead, file, 80, 4, 1648);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 90, 8, 1936);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 91, 8, 1991);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 92, 8, 2049);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 93, 16, 2100);
			add_location(tr1, file, 89, 8, 1923);
			...
			add_location(td6, file, 98, 8, 2300);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 99, 16, 2351);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 95, 8, 2157);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 102, 8, 2421);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 103, 8, 2477);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 104, 8, 2520);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 105, 16, 2571);
			add_location(tr3, file, 101, 8, 2408);
			add_location(tbody, file, 88, 4, 1907);
			...
			add_location(h3, file, 114, 1, 2664);
			add_location(div6, file, 113, 0, 2656);
		},
