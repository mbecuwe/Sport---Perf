...
import Cycling_charts from './cycling-charts.56e7d721.js';
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t8 = space();
			th3 = element("th");
			t9 = text("Variation x. past month");
			t10 = space();
			tbody = element("tbody");
			tr1 = element("tr");
			td0 = element("td");
		...
		l: function claim(nodes) {
			...
			t9 = claim_text(th3_nodes, "Variation x. past month");
		...
		h: function hydrate() {
			...
			add_location(th3, file, 74, 8, 1482);
			add_location(tr0, file, 70, 8, 1321);
			add_location(thead, file, 69, 4, 1305);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 79, 8, 1593);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 80, 8, 1649);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 81, 8, 1692);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 82, 16, 1743);
			add_location(tr1, file, 78, 8, 1580);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 85, 8, 1833);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 86, 8, 1892);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 87, 8, 1935);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 88, 16, 1986);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 84, 8, 1800);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 91, 8, 2056);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 92, 8, 2116);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 93, 8, 2159);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 94, 16, 2210);
			add_location(tr3, file, 90, 8, 2043);
			add_location(tbody, file, 77, 4, 1564);
			...
			add_location(h3, file, 103, 1, 2303);
			add_location(div6, file, 102, 0, 2295);
		},
