...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			if (img.src !== (img_src_value = "workout_drawing.jpg")) attr_dev(img, "src", img_src_value);
			...
			add_location(input3, file, 89, 8, 3672);
			add_location(br3, file, 90, 12, 3889);
			...
			add_location(button, file, 92, 8, 3905);
			add_location(form, file, 63, 8, 2234);
			add_location(br4, file, 95, 12, 4137);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4155);
			attr_dev(div3, "class", " p-2");
			add_location(div3, file, 62, 4, 2207);
			attr_dev(div4, "class", "flex-initial w-2/3 p-2");
			add_location(div4, file, 58, 2, 2060);
