import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.02c59ea7.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label1, file, 133, 8, 5217);
			...
			add_location(input3, file, 146, 8, 6077);
			add_location(br3, file, 147, 12, 6294);
			...
			add_location(button, file, 149, 8, 6310);
			add_location(form, file, 120, 8, 4639);
			add_location(br4, file, 152, 12, 6542);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 156, 8, 6560);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*minutes*/ 4 && to_number(input2.value) !== /*minutes*/ ctx[2]) {
				set_input_value(input2, /*minutes*/ ctx[2]);
			}

			if (dirty[0] & /*elevation*/ 8 && to_number(input3.value) !== /*elevation*/ ctx[3]) {
				set_input_value(input3, /*elevation*/ ctx[3]);
			}
		},
		i: noop,
