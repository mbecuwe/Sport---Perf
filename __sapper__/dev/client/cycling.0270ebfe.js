import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.491c281a.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.e46fae35.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 117, 4, 3281);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 116, 2, 3240);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 123, 4, 3467);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 122, 4, 3433);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 121, 2, 3392);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 115, 0, 3214);
			add_location(li0, file, 132, 4, 3602);
			add_location(li1, file, 133, 8, 3622);
			add_location(lu, file, 131, 4, 3593);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 129, 0, 3534);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 143, 8, 3750);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 144, 8, 3793);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 145, 8, 3834);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 146, 8, 3900);
			add_location(tr0, file, 142, 8, 3737);
			add_location(thead0, file, 141, 4, 3721);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 151, 8, 4018);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 152, 8, 4073);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 153, 8, 4131);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 154, 8, 4194);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 155, 8, 4260);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 156, 8, 4324);
			add_location(tr1, file, 150, 8, 4005);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 159, 8, 4438);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 160, 8, 4493);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 161, 8, 4548);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 162, 8, 4608);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 163, 8, 4671);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 164, 8, 4732);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 158, 8, 4405);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 167, 8, 4823);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 168, 8, 4879);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 169, 8, 4938);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 170, 8, 5002);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 171, 8, 5069);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 172, 8, 5134);
			add_location(tr3, file, 166, 8, 4810);
			add_location(tbody0, file, 149, 4, 3989);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 140, 4, 3677);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 139, 0, 3654);
			add_location(h3, file, 182, 1, 5272);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 181, 0, 5246);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 194, 8, 5484);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 195, 8, 5527);
			attr_dev(th6, "colspan", "2");
			attr_dev(th6, "class", "px-4 py-2 ");
			add_location(th6, file, 196, 8, 5568);
			attr_dev(th7, "colspan", "2");
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 197, 8, 5634);
			add_location(tr4, file, 193, 8, 5471);
			add_location(thead1, file, 192, 4, 5455);
			attr_dev(td18, "class", "border px-4 py-2");
			add_location(td18, file, 202, 8, 5752);
			attr_dev(td19, "class", "border px-4 py-2");
			add_location(td19, file, 203, 8, 5807);
			attr_dev(td20, "class", "border px-4 py-2");
			add_location(td20, file, 204, 8, 5865);
			attr_dev(td21, "class", "border px-4 py-2");
			add_location(td21, file, 205, 8, 5928);
			attr_dev(td22, "class", "border px-4 py-2");
			add_location(td22, file, 206, 8, 5994);
			attr_dev(td23, "class", "border px-4 py-2");
			add_location(td23, file, 207, 8, 6058);
			add_location(tr5, file, 201, 8, 5739);
			attr_dev(td24, "class", "border px-4 py-2");
			add_location(td24, file, 210, 8, 6172);
			attr_dev(td25, "class", "border px-4 py-2");
			add_location(td25, file, 211, 8, 6227);
			attr_dev(td26, "class", "border px-4 py-2");
			add_location(td26, file, 212, 8, 6282);
			attr_dev(td27, "class", "border px-4 py-2");
			add_location(td27, file, 213, 8, 6342);
			attr_dev(td28, "class", "border px-4 py-2");
			add_location(td28, file, 214, 8, 6405);
			attr_dev(td29, "class", "border px-4 py-2");
			add_location(td29, file, 215, 8, 6466);
			attr_dev(tr6, "class", "bg-gray-100");
			add_location(tr6, file, 209, 8, 6139);
			attr_dev(td30, "class", "border px-4 py-2");
			add_location(td30, file, 218, 8, 6557);
			attr_dev(td31, "class", "border px-4 py-2");
			add_location(td31, file, 219, 8, 6613);
			attr_dev(td32, "class", "border px-4 py-2");
			add_location(td32, file, 220, 8, 6672);
			attr_dev(td33, "class", "border px-4 py-2");
			add_location(td33, file, 221, 8, 6736);
			attr_dev(td34, "class", "border px-4 py-2");
			add_location(td34, file, 222, 8, 6803);
			attr_dev(td35, "class", "border px-4 py-2");
			add_location(td35, file, 223, 8, 6868);
			add_location(tr7, file, 217, 8, 6544);
			add_location(tbody1, file, 200, 4, 5723);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 191, 4, 5411);
			attr_dev(div8, "class", "p-10");
			add_location(div8, file, 190, 0, 5388);
			add_location(div9, file, 186, 0, 5348);
		},
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
