import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, j as attr_dev, k as add_location, I as set_style, l as insert_dev, m as append_dev, n as noop } from './client.9d87f06b.js';
import Box from './Box.66e35e2f.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			div12 = claim_element(body_nodes, "DIV", { class: true, style: true });
			...
			t0 = claim_text(h1_nodes, "Add New Session");
		...
		h: function hydrate() {
			...
			add_location(img0, file, 30, 4, 856);
			attr_dev(a0, "href", "new_session/cycling/new_cycling");
			add_location(a0, file, 29, 4, 809);
			attr_dev(div1, "class", "hover:shadow-2xl hover:border-blue-800");
			add_location(div1, file, 28, 3, 752);
			attr_dev(div2, "class", "text-center mx-4 md:w-1/2");
			add_location(div2, file, 26, 2, 627);
			attr_dev(p1, "class", "font-semibold tracking-wider text-xl text-blue-700 pb-6");
			add_location(p1, file, 35, 3, 992);
			...
			add_location(img1, file, 38, 4, 1178);
			attr_dev(a1, "href", "new_session/running/new_running");
			add_location(a1, file, 37, 4, 1131);
			attr_dev(div3, "class", "hover:shadow-2xl hover:border-blue-800");
			add_location(div3, file, 36, 3, 1074);
			attr_dev(div4, "class", " text-center mx-4  md:w-1/2 ");
			add_location(div4, file, 34, 2, 946);
			attr_dev(div5, "class", "md:flex justify-center mb-8");
			add_location(div5, file, 25, 1, 583);
			attr_dev(p2, "class", "font-semibold tracking-wider text-xl text-blue-700 pb-6");
			add_location(p2, file, 45, 3, 1358);
			...
			add_location(img2, file, 48, 4, 1545);
			attr_dev(a2, "href", "new_session/workout/new_workout");
			add_location(a2, file, 47, 4, 1498);
			attr_dev(div6, "class", "hover:shadow-2xl hover:border-blue-800");
			add_location(div6, file, 46, 3, 1441);
			attr_dev(div7, "class", " text-center mx-4 md:w-1/2");
			add_location(div7, file, 44, 2, 1314);
			attr_dev(p3, "class", "font-semibold tracking-wider text-xl text-blue-700 pb-6");
			add_location(p3, file, 53, 3, 1679);
			...
			add_location(img3, file, 56, 4, 1868);
			attr_dev(a3, "href", "new_session/swimming/new_swimming");
			add_location(a3, file, 55, 4, 1819);
			attr_dev(div8, "class", "hover:shadow-2xl hover:border-blue-800");
			add_location(div8, file, 54, 3, 1762);
			attr_dev(div9, "class", " text-center mx-4  md:w-1/2 ");
			add_location(div9, file, 52, 2, 1633);
			attr_dev(div10, "class", "md:flex justify-center");
			add_location(div10, file, 43, 1, 1275);
			attr_dev(div11, "class", " m-20");
			add_location(div11, file, 17, 1, 406);
			attr_dev(div12, "class", "m-2 rounded-lg shadow-lg bg-gray-600 w-full flex flex-row flex-wrap p-3 antialiased");
			set_style(div12, "background-image", "url(performance.png)");
			set_style(div12, "background-repeat", "no-repat");
			set_style(div12, "background-size", "cover");
			set_style(div12, "background-color", "rgba(255,255,255,0.6)");
			set_style(div12, "background-blend-mode", "lighten");
			add_location(div12, file, 9, 1, 91);
			attr_dev(body, "class", "");
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
