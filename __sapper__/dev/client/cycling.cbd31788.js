import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.5a556f8d.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.3b114a02.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 143, 12, 4271);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h10, file, 139, 8, 4063);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 141, 8, 4131);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 138, 4, 4035);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 149, 8, 4403);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 152, 12, 4582);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 155, 16, 4827);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 156, 16, 4879);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 157, 16, 4929);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 158, 16, 5004);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 154, 16, 4762);
			attr_dev(thead0, "class", "border-gray-300");
			add_location(thead0, file, 153, 12, 4713);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 163, 16, 5167);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 164, 16, 5231);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 165, 16, 5298);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 166, 16, 5382);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 167, 16, 5457);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 168, 16, 5547);
			add_location(tr1, file, 162, 16, 5145);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 171, 16, 5677);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 172, 16, 5741);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 173, 16, 5822);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 174, 16, 5908);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 175, 16, 5980);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 176, 16, 6067);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 170, 16, 5646);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 179, 16, 6185);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 180, 16, 6246);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 181, 16, 6314);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 182, 16, 6404);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 183, 16, 6480);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 184, 16, 6571);
			add_location(tr3, file, 178, 16, 6163);
			add_location(tbody0, file, 161, 12, 5120);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 151, 12, 4512);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 150, 8, 4462);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 195, 12, 6859);
			...
			add_location(div8, file, 148, 4, 4365);
