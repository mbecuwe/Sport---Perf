...
import Swimming_charts from './swimming-charts.64fd4e47.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 165, 12, 4640);
		},
...
// (232:16) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 233, 16, 8303);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 234, 16, 8373);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 235, 16, 8434);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 236, 16, 8507);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 237, 16, 8621);
			add_location(tr, file, 232, 16, 8282);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(232:16) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 149, 8, 3992);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 148, 4, 3957);
			...
			add_location(td3, file, 188, 16, 5735);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 189, 16, 5886);
			...
			add_location(td5, file, 190, 16, 5975);
			add_location(tr1, file, 184, 16, 5502);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 193, 16, 6181);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 194, 16, 6244);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 195, 16, 6324);
			...
			add_location(td9, file, 196, 16, 6409);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 197, 16, 6551);
			...
			add_location(td11, file, 198, 16, 6637);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 192, 16, 6151);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 201, 16, 6825);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 202, 16, 6883);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 203, 16, 6947);
			...
			add_location(td15, file, 204, 16, 7033);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 205, 16, 7178);
			...
			add_location(td17, file, 206, 16, 7265);
			add_location(tr3, file, 200, 16, 6804);
			add_location(tbody0, file, 183, 12, 5478);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 173, 12, 4873);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 172, 8, 4824);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 217, 12, 7614);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 220, 16, 7865);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 221, 16, 7913);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 222, 16, 7969);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 223, 16, 8023);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 224, 16, 8079);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 219, 16, 7801);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 218, 12, 7746);
			add_location(tbody1, file, 229, 12, 8187);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 216, 12, 7545);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 215, 8, 7496);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 246, 12, 8837);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 245, 8, 8806);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 170, 4, 4729);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 159, 0, 4384);
			attr_dev(div10, "class", "mb-20");
			add_location(div10, file, 147, 0, 3933);
			attr_dev(div11, "class", "bg-white");
			add_location(div11, file, 145, 0, 3909);
		},
		m: function mount(target, anchor) {
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
