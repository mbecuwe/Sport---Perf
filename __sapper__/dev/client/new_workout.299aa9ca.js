import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.d6391d21.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(label0, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold m-2");
			...
			add_location(br0, file, 135, 12, 5343);
			attr_dev(label1, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xl font-bold mb-2");
			add_location(label1, file, 137, 12, 5363);
			attr_dev(label2, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xs font-bold m-3");
			add_location(label2, file, 141, 16, 5534);
			...
			add_location(input1, file, 145, 20, 5740);
			attr_dev(div4, "class", "flex w-1/2 m-3");
			add_location(div4, file, 144, 16, 5691);
			...
			add_location(input8, file, 186, 8, 8220);
			add_location(br7, file, 187, 12, 8437);
			...
			add_location(button, file, 189, 8, 8453);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 192, 12, 8685);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 196, 8, 8703);
