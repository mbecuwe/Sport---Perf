import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.b5e4afff.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.0d40d8bf.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 143, 4, 4024);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 12, 6411);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 12, 6478);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 12, 6536);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 12, 6606);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 12, 6717);
			add_location(tr, file, 210, 12, 6393);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 128, 4, 3584);
			...
			add_location(div1, file, 133, 4, 3718);
			attr_dev(div2, "class", "flex justify-center p-2");
			add_location(div2, file, 132, 0, 3675);
			add_location(lu, file, 141, 4, 3958);
			attr_dev(div3, "class", "px-10");
			add_location(div3, file, 139, 0, 3897);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 153, 8, 4177);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 154, 8, 4221);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 155, 8, 4263);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 156, 8, 4330);
			add_location(tr0, file, 152, 8, 4163);
			add_location(thead0, file, 151, 4, 4146);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 161, 8, 4453);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 162, 8, 4509);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 163, 8, 4568);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 164, 8, 4644);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 165, 8, 4711);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 166, 8, 4793);
			add_location(tr1, file, 160, 8, 4439);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 169, 8, 4910);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 170, 8, 4966);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 171, 8, 5039);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 172, 8, 5117);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 173, 8, 5181);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 174, 8, 5260);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 168, 8, 4876);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 177, 8, 5354);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 178, 8, 5407);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 179, 8, 5467);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 180, 8, 5549);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 181, 8, 5617);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 182, 8, 5700);
			add_location(tr3, file, 176, 8, 5340);
			add_location(tbody0, file, 159, 4, 4422);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 150, 4, 4101);
			attr_dev(div4, "class", "p-10");
			add_location(div4, file, 149, 0, 4077);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 198, 12, 6002);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 12, 6047);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 12, 6100);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 12, 6151);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 12, 6204);
			add_location(tr4, file, 197, 12, 5984);
			add_location(thead1, file, 196, 8, 5963);
			add_location(tbody1, file, 207, 8, 6307);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 195, 8, 5914);
			attr_dev(div5, "class", "py-5");
			add_location(div5, file, 194, 4, 5886);
			attr_dev(div6, "class", "px-10 py-5");
			add_location(div6, file, 191, 0, 5821);
			add_location(h3, file, 229, 1, 6924);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 228, 0, 6897);
		},
		m: function mount(target, anchor) {
