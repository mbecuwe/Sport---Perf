...
import Cycling_charts from './cycling-charts.4f36bebe.js';
...
function instance($$self, $$props, $$invalidate) {
	...
	console.log(list_elevation.slice(list_elevation.length - 3, list_elevation.length - 1));
