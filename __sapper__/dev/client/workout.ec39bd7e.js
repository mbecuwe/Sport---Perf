import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_each_argument, a as validate_slots, e as element, t as text, c as claim_element, f as children, j as claim_text, g as detach_dev, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as noop, b as space, h as claim_space, G as create_component, H as claim_component, I as toggle_class, J as mount_component, D as transition_in, E as transition_out, p as destroy_each, K as destroy_component } from './client.06310358.js';
import './moment.98d1f4f0.js';
import './Chart.d62ec9f6.js';
import Workoutpushups_radar from './workoutpushups-radar.9c508563.js';
import Workoutothers_radar from './workoutothers-radar.4ad9791e.js';
import Workoutabdo_radar from './workoutabdo-radar.aff9cb1e.js';
import Workoutlegs_radar from './workoutlegs-radar.7dd24632.js';
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 403, 12, 12884);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 404, 12, 12945);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 405, 12, 13020);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 406, 12, 13095);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 407, 12, 13178);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 408, 12, 13261);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 409, 12, 13344);
			attr_dev(td7, "class", "border px-2 py-2");
			add_location(td7, file, 410, 12, 13427);
			attr_dev(td8, "class", "border px-2 py-2");
			add_location(td8, file, 411, 12, 13508);
			attr_dev(td9, "class", "border px-2 py-2");
			add_location(td9, file, 412, 12, 13589);
			attr_dev(td10, "class", "border px-2 py-2");
			add_location(td10, file, 413, 12, 13671);
			add_location(tr, file, 402, 12, 12867);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 462, 12, 15507);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 463, 12, 15568);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 464, 12, 15644);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 465, 12, 15720);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 466, 12, 15804);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 467, 12, 15888);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 468, 12, 15969);
			add_location(tr, file, 461, 12, 15490);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 516, 12, 17817);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 517, 12, 17878);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 518, 12, 17950);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 519, 12, 18022);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 520, 12, 18102);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 521, 12, 18182);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 522, 12, 18257);
			add_location(tr, file, 515, 12, 17800);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file, 357, 48, 10949);
			...
			add_location(span3, file, 529, 28, 18438);
			add_location(div19, file, 529, 0, 18410);
			attr_dev(caption7, "class", "text-center container mx-auto font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption7, file, 534, 12, 18685);
			attr_dev(div20, "class", "mt-8  m-12  ");
			add_location(div20, file, 533, 4, 18646);
