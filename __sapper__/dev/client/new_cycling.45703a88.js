...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t19 = claim_text(button0_nodes, "Add Session");
			...
			t21 = claim_text(button1_nodes, "Add Session");
		...
		h: function hydrate() {
			...
			attr_dev(button0, "class", "bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded");
			add_location(button0, file, 95, 8, 4003);
			attr_dev(div2, "class", "flex");
			add_location(div2, file, 94, 8, 3976);
			attr_dev(div3, "class", "flex justify-end mx-2 my-8");
			...
			add_location(button1, file, 102, 8, 4256);
			add_location(form, file, 63, 8, 2242);
			add_location(br4, file, 107, 12, 4490);
			attr_dev(div4, "id", "add_to_me");
			add_location(div4, file, 111, 8, 4508);
