...
import Cycling_charts from './cycling-charts.ed378e3e.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 162, 12, 4680);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 230, 16, 8367);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 231, 16, 8437);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 232, 16, 8498);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 233, 16, 8571);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 234, 16, 8685);
			add_location(tr, file, 229, 16, 8346);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 147, 8, 4033);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 146, 4, 3998);
			...
			add_location(td3, file, 185, 16, 5775);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 186, 16, 5926);
			...
			add_location(td5, file, 187, 16, 6015);
			add_location(tr1, file, 181, 16, 5542);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 190, 16, 6221);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 191, 16, 6284);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 192, 16, 6364);
			...
			add_location(td9, file, 193, 16, 6449);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 194, 16, 6591);
			...
			add_location(td11, file, 195, 16, 6677);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 189, 16, 6191);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 198, 16, 6865);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 199, 16, 6925);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 200, 16, 6992);
			...
			add_location(td15, file, 201, 16, 7081);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 202, 16, 7235);
			...
			add_location(td17, file, 203, 16, 7325);
			add_location(tr3, file, 197, 16, 6844);
			add_location(tbody0, file, 180, 12, 5518);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 170, 12, 4913);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 169, 8, 4864);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 214, 12, 7683);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 217, 16, 7923);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 218, 16, 7971);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 219, 16, 8027);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 220, 16, 8081);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 221, 16, 8137);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 216, 16, 7859);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 215, 12, 7804);
			add_location(tbody1, file, 226, 12, 8251);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 213, 12, 7614);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 212, 8, 7565);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 243, 12, 8904);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 242, 8, 8873);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 167, 4, 4769);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 156, 0, 4427);
			attr_dev(div10, "class", "mb-20");
			add_location(div10, file, 145, 0, 3974);
		},
		m: function mount(target, anchor) {
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
