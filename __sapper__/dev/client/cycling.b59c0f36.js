import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, K as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as attr_dev, j as add_location, m as insert_dev, n as append_dev, o as noop, a as space, c as claim_space, x as create_component, y as claim_component, z as mount_component, A as transition_in, B as transition_out, L as destroy_each, C as destroy_component } from './client.4d324a16.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.6b5b1dad.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 143, 12, 4272);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 16, 7567);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 16, 7638);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 16, 7700);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 16, 7774);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 16, 7889);
			add_location(tr, file, 210, 16, 7545);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 128, 8, 3632);
			...
			add_location(div1, file, 133, 8, 3852);
			attr_dev(div2, "class", "flex justify-center mb-16 bg-blue-700 border-2 border-gray-300 shadow-lg rounded-t-md");
			add_location(div2, file, 132, 4, 3743);
			attr_dev(h10, "class", "text-blue-800  mb-8 ");
			add_location(h10, file, 139, 8, 4064);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 141, 8, 4132);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 138, 4, 4036);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 149, 8, 4404);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 152, 12, 4583);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 155, 16, 4835);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 156, 16, 4887);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 157, 16, 4937);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 158, 16, 5012);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 154, 16, 4770);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 153, 12, 4714);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 163, 16, 5175);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 164, 16, 5239);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 165, 16, 5306);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 166, 16, 5390);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 167, 16, 5465);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 168, 16, 5555);
			add_location(tr1, file, 162, 16, 5153);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 171, 16, 5685);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 172, 16, 5749);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 173, 16, 5830);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 174, 16, 5916);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 175, 16, 5988);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 176, 16, 6075);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 170, 16, 5654);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 179, 16, 6193);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 180, 16, 6254);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 181, 16, 6322);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 182, 16, 6412);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 183, 16, 6488);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 184, 16, 6579);
			add_location(tr3, file, 178, 16, 6171);
			add_location(tbody0, file, 161, 12, 5128);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 151, 12, 4513);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 150, 8, 4463);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 195, 12, 6867);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 198, 16, 7110);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 16, 7159);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 16, 7216);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 16, 7271);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 16, 7328);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 197, 16, 7045);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 196, 12, 6989);
			add_location(tbody1, file, 207, 12, 7447);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 194, 12, 6797);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 193, 8, 6747);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 227, 12, 8123);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 226, 8, 8091);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 148, 4, 4366);
