...
import Running_charts from './running-charts.0830eea0.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 217, 12, 6301);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 218, 12, 6367);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 219, 12, 6424);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 220, 12, 6493);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 221, 12, 6603);
			add_location(tr, file, 216, 12, 6284);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 170, 8, 4581);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 171, 8, 4647);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 172, 8, 4728);
			add_location(tr1, file, 166, 8, 4380);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 175, 8, 4842);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 176, 8, 4897);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 177, 8, 4969);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 178, 8, 5046);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 179, 8, 5109);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 180, 8, 5187);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 174, 8, 4809);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 183, 8, 5278);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 184, 8, 5330);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 185, 8, 5389);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 186, 8, 5470);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 187, 8, 5537);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 188, 8, 5619);
			add_location(tr3, file, 182, 8, 5265);
			...
			add_location(th4, file, 204, 12, 5905);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 205, 12, 5949);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 206, 12, 6001);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 207, 12, 6051);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 208, 12, 6103);
			add_location(tr4, file, 203, 12, 5888);
			add_location(thead1, file, 202, 8, 5868);
			add_location(tbody1, file, 213, 8, 6201);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 201, 8, 5820);
			attr_dev(div7, "class", "py-5");
			add_location(div7, file, 200, 4, 5793);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 197, 0, 5731);
			add_location(h3, file, 235, 1, 6796);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 234, 0, 6770);
		},
		m: function mount(target, anchor) {
