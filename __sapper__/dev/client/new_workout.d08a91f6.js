import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.580f54f6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label3, file, 162, 20, 6382);
			attr_dev(div8, "class", "flex w-1/2 m-2");
			add_location(div8, file, 161, 16, 6333);
			...
			add_location(input3, file, 166, 20, 6600);
			attr_dev(div9, "class", "flex w-1/2 m-2");
			add_location(div9, file, 165, 16, 6551);
			...
			add_location(input5, file, 180, 20, 7412);
			attr_dev(div13, "class", "flex w-1/2 m-2");
			add_location(div13, file, 179, 16, 7363);
			...
			add_location(input7, file, 195, 20, 8246);
			attr_dev(div17, "class", "flex w-1/2 m-2");
			add_location(div17, file, 194, 16, 8197);
			...
			add_location(input9, file, 217, 20, 9172);
			attr_dev(div21, "class", "flex w-1/2 m-2");
			add_location(div21, file, 216, 16, 9123);
			...
			add_location(input11, file, 235, 20, 9974);
			attr_dev(div25, "class", "flex w-1/2 m-2");
			add_location(div25, file, 234, 16, 9925);
			...
			add_location(input13, file, 250, 20, 10805);
			attr_dev(div29, "class", "flex w-1/2 m-2");
			add_location(div29, file, 249, 16, 10756);
			...
			add_location(input14, file, 253, 20, 11064);
			attr_dev(div30, "class", "flex w-1/2 m-2");
			add_location(div30, file, 252, 16, 11015);
			attr_dev(div31, "class", "flex");
			add_location(div31, file, 244, 12, 10509);
			...
			add_location(button, file, 260, 8, 11354);
			attr_dev(div32, "class", "flex");
			add_location(div32, file, 259, 8, 11327);
			attr_dev(div33, "class", "flex justify-center");
			add_location(div33, file, 258, 8, 11285);
			add_location(form, file, 120, 8, 4644);
			add_location(br2, file, 268, 12, 11635);
			attr_dev(div34, "id", "add_to_me");
			add_location(div34, file, 272, 8, 11653);
			attr_dev(div35, "class", " p-2");
			add_location(div35, file, 119, 4, 4617);
			attr_dev(div36, "class", "flex-initial w-2/3 p-2");
			add_location(div36, file, 115, 2, 4465);
			attr_dev(div37, "class", "flex ");
			add_location(div37, file, 107, 0, 4250);
		},
