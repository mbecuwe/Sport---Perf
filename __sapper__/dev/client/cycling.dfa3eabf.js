import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.3714914f.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.40619fc0.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 87, 4, 2098);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 86, 2, 2057);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 93, 4, 2284);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 92, 4, 2250);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 91, 2, 2209);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 85, 0, 2031);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 104, 8, 2448);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 105, 8, 2491);
			attr_dev(th2, "class", "px-4 py-2");
			add_location(th2, file, 106, 8, 2532);
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 107, 8, 2587);
			add_location(tr0, file, 103, 8, 2435);
			add_location(thead, file, 102, 4, 2419);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 112, 8, 2689);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 113, 8, 2744);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 114, 8, 2802);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 115, 16, 2853);
			add_location(tr1, file, 111, 8, 2676);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 118, 8, 2943);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 119, 8, 2998);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 120, 8, 3053);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 121, 16, 3104);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 117, 8, 2910);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 124, 8, 3174);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 125, 8, 3230);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 126, 8, 3289);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 127, 16, 3340);
			add_location(tr3, file, 123, 8, 3161);
			add_location(tbody, file, 110, 4, 2660);
			attr_dev(table, "class", "table-auto text-center ");
			add_location(table, file, 101, 4, 2375);
			attr_dev(div5, "class", "p-10");
			add_location(div5, file, 100, 0, 2352);
			attr_dev(h3, "class", "px-10 py-5");
			add_location(h3, file, 136, 1, 3433);
			add_location(div6, file, 135, 0, 3425);
		},
