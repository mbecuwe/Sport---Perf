import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.380b4426.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input8, file, 184, 8, 8181);
			add_location(br7, file, 185, 12, 8398);
			...
			add_location(button, file, 187, 8, 8414);
			add_location(form, file, 120, 8, 4644);
			add_location(br8, file, 190, 12, 8646);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 194, 8, 8664);
