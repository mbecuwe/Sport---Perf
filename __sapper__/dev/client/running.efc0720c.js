...
import Running_charts from './running-charts.a2e532e2.js';
...
// (156:8) {#each get_last_nb_sessions(3, list_date) as date}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 156, 8, 4605);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(156:8) {#each get_last_nb_sessions(3, list_date) as date}",
		ctx
	});
...
// (223:16) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 224, 16, 7240);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 225, 16, 7311);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 226, 16, 7373);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 227, 16, 7447);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 228, 16, 7562);
			add_location(tr, file, 223, 16, 7218);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(223:16) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	let t19;
	let td2;
	let t20_value = round_2_decimal(/*average_3_distance*/ ctx[9]) + "";
	let t20;
	let t21;
	let td3;
	let t22;
	...
	const block = {
		c: function create() {
			...
			t5 = space();
			div5 = element("div");
			t6 = text("Your last sessions took place on: \r\n        ");
			lu = element("lu");
		...
		l: function claim(nodes) {
			...
			t6 = claim_text(div5_nodes, "Your last sessions took place on: \r\n        ");
			...
			t58 = claim_text(div8_nodes, "Get the data available in table\r\n\r\n        ");
		...
		h: function hydrate() {
			...
			add_location(h1, file, 143, 8, 4160);
			...
			add_location(lu, file, 154, 8, 4531);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 152, 4, 4462);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 166, 12, 4790);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 167, 12, 4838);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 168, 12, 4884);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 169, 12, 4955);
			add_location(tr0, file, 165, 12, 4772);
			add_location(thead0, file, 164, 8, 4751);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 174, 12, 5098);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 175, 12, 5158);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 176, 12, 5221);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 177, 12, 5306);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 178, 12, 5377);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 179, 12, 5463);
			add_location(tr1, file, 173, 12, 5080);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 182, 12, 5592);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 183, 12, 5652);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 184, 12, 5729);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 185, 12, 5811);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 186, 12, 5879);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 187, 12, 5962);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 181, 12, 5554);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 190, 12, 6068);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 191, 12, 6125);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 192, 12, 6189);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 193, 12, 6275);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 194, 12, 6347);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 195, 12, 6434);
			add_location(tr3, file, 189, 12, 6050);
			add_location(tbody0, file, 172, 8, 5059);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 163, 8, 4702);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 162, 4, 4674);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 211, 16, 6783);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 212, 16, 6832);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 213, 16, 6889);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 214, 16, 6944);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 215, 16, 7001);
			add_location(tr4, file, 210, 16, 6761);
			add_location(thead1, file, 209, 12, 6736);
			add_location(tbody1, file, 220, 12, 7120);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 208, 12, 6683);
			attr_dev(div7, "class", "py-5");
			add_location(div7, file, 207, 8, 6651);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 204, 4, 6578);
			add_location(h3, file, 242, 8, 7808);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 241, 4, 7774);
			attr_dev(div10, "class", "mb-20");
			add_location(div10, file, 130, 0, 3668);
		},
		m: function mount(target, anchor) {
