...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input2, file, 84, 8, 3317);
			add_location(br2, file, 85, 12, 3528);
			...
			add_location(label3, file, 87, 8, 3544);
			...
			add_location(input3, file, 89, 8, 3679);
			add_location(br3, file, 90, 12, 3906);
			...
			add_location(button, file, 92, 8, 3922);
			add_location(form, file, 63, 8, 2246);
			add_location(br4, file, 95, 12, 4154);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4172);
			attr_dev(div3, "class", " p-2");
			add_location(div3, file, 62, 4, 2219);
			attr_dev(div4, "class", "flex-initial w-2/3 p-2");
			add_location(div4, file, 58, 2, 2071);
			attr_dev(div5, "class", "flex ");
			add_location(div5, file, 50, 0, 1854);
		},
