...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(div4_nodes, "Cycling New Session");
			...
			t17 = claim_text(label3_nodes, "Elevation (m)");
		...
		h: function hydrate() {
			...
			add_location(input3, file, 94, 8, 3985);
			add_location(br3, file, 95, 12, 4202);
			...
			add_location(button, file, 100, 8, 4290);
			attr_dev(div5, "class", "flex");
			add_location(div5, file, 99, 8, 4263);
			attr_dev(div6, "class", "flex justify-end my-8");
			add_location(div6, file, 98, 8, 4219);
			add_location(form, file, 68, 8, 2534);
			add_location(br4, file, 108, 12, 4563);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 112, 8, 4581);
			attr_dev(div8, "class", " p-2");
			add_location(div8, file, 67, 4, 2507);
			attr_dev(div9, "class", "flex-initial w-2/3 p-2");
			add_location(div9, file, 63, 2, 2360);
			attr_dev(div10, "class", "flex justify-center text-blue-700 ");
			add_location(div10, file, 61, 0, 2308);
		},
