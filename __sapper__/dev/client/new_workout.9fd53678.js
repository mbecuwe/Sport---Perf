import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.145ea6e5.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t12 = claim_text(label2_nodes, "Distance (m)");
			...
			t16 = claim_text(label3_nodes, "Distance (m)");
			...
			t20 = claim_text(label4_nodes, "Distance (m)");
			...
			t24 = claim_text(label5_nodes, "Distance (m)");
			...
			t28 = claim_text(label6_nodes, "Minutes");
			...
			t32 = claim_text(label7_nodes, "Elevation (m)");
		...
		h: function hydrate() {
			...
			add_location(label1, file, 135, 16, 5264);
			...
			add_location(input1, file, 139, 20, 5482);
			attr_dev(div2, "class", "flex w-1/2");
			add_location(div2, file, 138, 16, 5437);
			...
			add_location(input2, file, 144, 20, 5772);
			attr_dev(div3, "class", "flex w-1/2");
			add_location(div3, file, 143, 16, 5727);
			attr_dev(div4, "class", "flex");
			add_location(div4, file, 134, 12, 5229);
			add_location(br1, file, 151, 11, 6025);
			attr_dev(label2, "for", "meters");
			attr_dev(label2, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label2, file, 152, 8, 6040);
			...
			add_location(input6, file, 170, 8, 7257);
			add_location(br5, file, 171, 12, 7465);
			attr_dev(label6, "for", "minutes");
			attr_dev(label6, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label6, file, 173, 8, 7481);
			...
			add_location(input7, file, 175, 8, 7613);
			add_location(br6, file, 176, 12, 7824);
			attr_dev(label7, "for", "elevation");
			attr_dev(label7, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label7, file, 178, 8, 7840);
			...
			add_location(input8, file, 180, 8, 7980);
			add_location(br7, file, 181, 12, 8197);
			...
			add_location(button, file, 183, 8, 8213);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 186, 12, 8445);
			attr_dev(div5, "id", "add_to_me");
			add_location(div5, file, 190, 8, 8463);
