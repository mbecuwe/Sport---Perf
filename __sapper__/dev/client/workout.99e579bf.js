import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_each_argument, a as validate_slots, e as element, t as text, c as claim_element, f as children, j as claim_text, g as detach_dev, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as noop, b as space, h as claim_space, G as create_component, H as claim_component, I as toggle_class, J as mount_component, D as transition_in, E as transition_out, p as destroy_each, K as destroy_component } from './client.e82cc122.js';
import './moment.98d1f4f0.js';
import './Chart.d62ec9f6.js';
import Workoutpushups_radar from './workoutpushups-radar.2e931a14.js';
import Workoutothers_radar from './workoutothers-radar.2d5410ab.js';
import Workoutabdo_radar from './workoutabdo-radar.2aa43ffa.js';
import Workoutlegs_radar from './workoutlegs-radar.3b96d90c.js';
...
function create_each_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 300, 12, 8699);
		},
...
function create_each_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 341, 12, 10147);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 342, 12, 10208);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 343, 12, 10281);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 344, 12, 10354);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 345, 12, 10433);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 346, 12, 10512);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 347, 12, 10591);
			attr_dev(td7, "class", "border px-2 py-2");
			add_location(td7, file, 348, 12, 10670);
			attr_dev(td8, "class", "border px-2 py-2");
			add_location(td8, file, 349, 12, 10746);
			add_location(tr, file, 340, 12, 10130);
		},
		m: function mount(target, anchor) {
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 403, 12, 12864);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 404, 12, 12925);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 405, 12, 13000);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 406, 12, 13075);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 407, 12, 13158);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 408, 12, 13241);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 409, 12, 13324);
			attr_dev(td7, "class", "border px-2 py-2");
			add_location(td7, file, 410, 12, 13407);
			attr_dev(td8, "class", "border px-2 py-2");
			add_location(td8, file, 411, 12, 13488);
			attr_dev(td9, "class", "border px-2 py-2");
			add_location(td9, file, 412, 12, 13569);
			attr_dev(td10, "class", "border px-2 py-2");
			add_location(td10, file, 413, 12, 13651);
			add_location(tr, file, 402, 12, 12847);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 462, 12, 15487);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 463, 12, 15548);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 464, 12, 15624);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 465, 12, 15700);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 466, 12, 15784);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 467, 12, 15868);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 468, 12, 15949);
			add_location(tr, file, 461, 12, 15470);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 516, 12, 17797);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 517, 12, 17858);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 518, 12, 17930);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 519, 12, 18002);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 520, 12, 18082);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 521, 12, 18162);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 522, 12, 18237);
			add_location(tr, file, 515, 12, 17780);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 287, 8, 8063);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 286, 4, 8028);
			...
			add_location(span3, file, 529, 28, 18418);
			add_location(div19, file, 529, 0, 18390);
			attr_dev(caption7, "class", "text-center container mx-auto font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption7, file, 534, 12, 18665);
			attr_dev(div20, "class", "mt-8  m-12  ");
			add_location(div20, file, 533, 4, 18626);
			attr_dev(div21, "class", "p-8");
			add_location(div21, file, 294, 0, 8446);
			attr_dev(div22, "class", "mb-20");
			add_location(div22, file, 285, 0, 8004);
