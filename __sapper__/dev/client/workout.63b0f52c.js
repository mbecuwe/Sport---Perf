import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_each_argument, a as validate_slots, e as element, t as text, c as claim_element, b as children, f as claim_text, g as detach_dev, h as attr_dev, j as add_location, k as insert_dev, l as append_dev, n as noop, m as space, o as claim_space, G as create_component, H as claim_component, I as toggle_class, J as mount_component, D as transition_in, E as transition_out, p as destroy_each, K as destroy_component } from './client.2de120f8.js';
import './Chart.ff97f108.js';
import Workoutpushups_radar from './workoutpushups-radar.b476a8b7.js';
import Workoutothers_radar from './workoutothers-radar.fa3cc73c.js';
import Workoutabdo_radar from './workoutabdo-radar.15f35170.js';
import Workoutlegs_radar from './workoutlegs-radar.99423579.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 460, 12, 15459);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 461, 12, 15520);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 462, 12, 15596);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 463, 12, 15672);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 464, 12, 15756);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 465, 12, 15840);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 466, 12, 15921);
			add_location(tr, file, 459, 12, 15442);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 514, 12, 17763);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 515, 12, 17824);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 516, 12, 17896);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 517, 12, 17968);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 518, 12, 18048);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 519, 12, 18128);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 520, 12, 18203);
			add_location(tr, file, 513, 12, 17746);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t86 = text("%");
			t87 = text(" of the average of the sessions where you worked on legs");
			t88 = space();
			div12 = element("div");
			...
			t120 = text("%");
			t121 = text(" of the average of the sessions where you worked on legs");
			t122 = space();
			div16 = element("div");
		...
		l: function claim(nodes) {
			...
			t87 = claim_text(div11_nodes, " of the average of the sessions where you worked on legs");
			...
			t121 = claim_text(div15_nodes, " of the average of the sessions where you worked on legs");
		...
		h: function hydrate() {
			...
			add_location(span3, file, 527, 28, 18384);
			add_location(div19, file, 527, 0, 18356);
			attr_dev(caption7, "class", "text-center container mx-auto font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption7, file, 532, 12, 18631);
			attr_dev(div20, "class", "mt-8  m-12  ");
			add_location(div20, file, 531, 4, 18592);
