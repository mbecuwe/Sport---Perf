...
import Cycling_charts from './cycling-charts.7e194c57.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 94, 4, 2266);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 93, 2, 2225);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 100, 4, 2452);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 99, 4, 2418);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 98, 2, 2377);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 92, 0, 2199);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 111, 8, 2616);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 112, 8, 2659);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 113, 8, 2700);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 114, 8, 2766);
			add_location(tr0, file, 110, 8, 2603);
			add_location(thead, file, 109, 4, 2587);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 119, 8, 2878);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 120, 8, 2933);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 121, 8, 2991);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 122, 8, 3054);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 123, 8, 3097);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 124, 8, 3140);
			add_location(tr1, file, 118, 8, 2865);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 127, 8, 3230);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 128, 8, 3285);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 129, 8, 3340);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 130, 16, 3408);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 131, 16, 3459);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 132, 16, 3510);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 126, 8, 3197);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 135, 8, 3580);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 136, 8, 3636);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 137, 8, 3695);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 138, 16, 3767);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 139, 16, 3818);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 140, 16, 3869);
			add_location(tr3, file, 134, 8, 3567);
			add_location(tbody, file, 117, 4, 2849);
			attr_dev(table, "class", "table-auto text-center ");
			add_location(table, file, 108, 4, 2543);
			attr_dev(div5, "class", "p-10");
			add_location(div5, file, 107, 0, 2520);
			attr_dev(h3, "class", "px-10 py-5");
			add_location(h3, file, 149, 1, 3962);
			add_location(div6, file, 148, 0, 3954);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	const variation_3_speed = variation(last_distance);
