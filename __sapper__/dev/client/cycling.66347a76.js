import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.3ce407ee.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.0ca21857.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file, 126, 4, 3417);
			add_location(li1, file, 127, 8, 3437);
			add_location(lu, file, 125, 4, 3408);
			add_location(p, file, 123, 0, 3365);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 137, 8, 3563);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 138, 8, 3606);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 139, 8, 3647);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 140, 8, 3713);
			add_location(tr0, file, 136, 8, 3550);
			add_location(thead, file, 135, 4, 3534);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 145, 8, 3831);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 146, 8, 3886);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 147, 8, 3944);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 148, 8, 4007);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 149, 8, 4073);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 150, 8, 4137);
			add_location(tr1, file, 144, 8, 3818);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 153, 8, 4251);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 154, 8, 4306);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 155, 8, 4361);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 156, 8, 4421);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 157, 8, 4484);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 158, 8, 4545);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 152, 8, 4218);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 161, 8, 4636);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 162, 8, 4692);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 163, 8, 4751);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 164, 8, 4815);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 165, 8, 4882);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 166, 8, 4947);
			add_location(tr3, file, 160, 8, 4623);
			add_location(tbody, file, 143, 4, 3802);
			attr_dev(table, "class", "table-auto text-center ");
			add_location(table, file, 134, 4, 3490);
			attr_dev(div5, "class", "p-10");
			add_location(div5, file, 133, 0, 3467);
			attr_dev(h3, "class", "px-10 py-5");
			add_location(h3, file, 176, 1, 5067);
			add_location(div6, file, 175, 0, 5059);
		},
