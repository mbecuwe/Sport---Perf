import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.6014248b.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.a76f4718.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 111, 4, 3134);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 110, 2, 3093);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 117, 4, 3320);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 116, 4, 3286);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 115, 2, 3245);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 109, 0, 3067);
			add_location(li0, file, 126, 4, 3455);
			add_location(li1, file, 127, 8, 3475);
			add_location(lu, file, 125, 4, 3446);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 123, 0, 3387);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 137, 8, 3603);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 138, 8, 3646);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 139, 8, 3687);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 140, 8, 3753);
			add_location(tr0, file, 136, 8, 3590);
			add_location(thead0, file, 135, 4, 3574);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 145, 8, 3871);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 146, 8, 3926);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 147, 8, 3984);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 148, 8, 4047);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 149, 8, 4113);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 150, 8, 4177);
			add_location(tr1, file, 144, 8, 3858);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 153, 8, 4291);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 154, 8, 4346);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 155, 8, 4401);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 156, 8, 4461);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 157, 8, 4524);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 158, 8, 4585);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 152, 8, 4258);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 161, 8, 4676);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 162, 8, 4732);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 163, 8, 4791);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 164, 8, 4855);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 165, 8, 4922);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 166, 8, 4987);
			add_location(tr3, file, 160, 8, 4663);
			add_location(tbody0, file, 143, 4, 3842);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 134, 4, 3530);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 133, 0, 3507);
			add_location(h3, file, 176, 1, 5125);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 175, 0, 5099);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 188, 8, 5337);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 189, 8, 5380);
			attr_dev(th6, "colspan", "2");
			attr_dev(th6, "class", "px-4 py-2 ");
			add_location(th6, file, 190, 8, 5421);
			attr_dev(th7, "colspan", "2");
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 191, 8, 5487);
			add_location(tr4, file, 187, 8, 5324);
			add_location(thead1, file, 186, 4, 5308);
			attr_dev(td18, "class", "border px-4 py-2");
			add_location(td18, file, 196, 8, 5605);
			attr_dev(td19, "class", "border px-4 py-2");
			add_location(td19, file, 197, 8, 5660);
			attr_dev(td20, "class", "border px-4 py-2");
			add_location(td20, file, 198, 8, 5718);
			attr_dev(td21, "class", "border px-4 py-2");
			add_location(td21, file, 199, 8, 5781);
			attr_dev(td22, "class", "border px-4 py-2");
			add_location(td22, file, 200, 8, 5847);
			attr_dev(td23, "class", "border px-4 py-2");
			add_location(td23, file, 201, 8, 5911);
			add_location(tr5, file, 195, 8, 5592);
			attr_dev(td24, "class", "border px-4 py-2");
			add_location(td24, file, 204, 8, 6025);
			attr_dev(td25, "class", "border px-4 py-2");
			add_location(td25, file, 205, 8, 6080);
			attr_dev(td26, "class", "border px-4 py-2");
			add_location(td26, file, 206, 8, 6135);
			attr_dev(td27, "class", "border px-4 py-2");
			add_location(td27, file, 207, 8, 6195);
			attr_dev(td28, "class", "border px-4 py-2");
			add_location(td28, file, 208, 8, 6258);
			attr_dev(td29, "class", "border px-4 py-2");
			add_location(td29, file, 209, 8, 6319);
			attr_dev(tr6, "class", "bg-gray-100");
			add_location(tr6, file, 203, 8, 5992);
			attr_dev(td30, "class", "border px-4 py-2");
			add_location(td30, file, 212, 8, 6410);
			attr_dev(td31, "class", "border px-4 py-2");
			add_location(td31, file, 213, 8, 6466);
			attr_dev(td32, "class", "border px-4 py-2");
			add_location(td32, file, 214, 8, 6525);
			attr_dev(td33, "class", "border px-4 py-2");
			add_location(td33, file, 215, 8, 6589);
			attr_dev(td34, "class", "border px-4 py-2");
			add_location(td34, file, 216, 8, 6656);
			attr_dev(td35, "class", "border px-4 py-2");
			add_location(td35, file, 217, 8, 6721);
			add_location(tr7, file, 211, 8, 6397);
			add_location(tbody1, file, 194, 4, 5576);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 185, 4, 5264);
			attr_dev(div8, "class", "p-10");
			add_location(div8, file, 184, 0, 5241);
			add_location(div9, file, 180, 0, 5201);
		},
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
