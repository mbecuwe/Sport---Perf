import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.e9d484f6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(button, "class", "items-center bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded");
			add_location(button, file, 159, 8, 6276);
			attr_dev(div7, "class", "content-center items-center");
			add_location(div7, file, 158, 8, 6226);
			add_location(form, file, 120, 8, 4644);
			add_location(br1, file, 165, 12, 6546);
			attr_dev(div8, "id", "add_to_me");
			add_location(div8, file, 169, 8, 6564);
