import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.6f8f168d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(label2, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold");
			...
			add_location(input1, file, 148, 20, 5794);
			attr_dev(div5, "class", "flex w-1/2 m-2");
			add_location(div5, file, 147, 16, 5745);
			...
			add_location(input3, file, 166, 20, 6598);
			attr_dev(div9, "class", "flex w-1/2 m-2");
			add_location(div9, file, 165, 16, 6549);
			...
			add_location(input4, file, 169, 20, 6870);
			attr_dev(div10, "class", "flex w-1/2 m-2");
			add_location(div10, file, 168, 16, 6821);
			attr_dev(div11, "class", "flex");
			add_location(div11, file, 160, 12, 6292);
			add_location(br2, file, 173, 12, 7107);
			attr_dev(label4, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xs font-bold m-3");
			add_location(label4, file, 177, 16, 7163);
			...
			add_location(input5, file, 181, 20, 7369);
			attr_dev(div12, "class", "flex w-1/2 m-2");
			add_location(div12, file, 180, 16, 7320);
			...
			add_location(input6, file, 184, 20, 7635);
			attr_dev(div13, "class", "flex w-1/2 m-2");
			add_location(div13, file, 183, 16, 7586);
			attr_dev(div14, "class", "flex");
			add_location(div14, file, 176, 12, 7128);
			add_location(br3, file, 188, 12, 7866);
			...
			add_location(button, file, 193, 8, 7952);
			attr_dev(div15, "class", "flex");
			add_location(div15, file, 192, 8, 7925);
			attr_dev(div16, "class", "flex justify-center");
			add_location(div16, file, 191, 8, 7883);
			add_location(form, file, 120, 8, 4644);
			add_location(br4, file, 201, 12, 8233);
			attr_dev(div17, "id", "add_to_me");
			add_location(div17, file, 205, 8, 8251);
