...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input3, file, 89, 8, 3784);
			add_location(br3, file, 90, 12, 4002);
			...
			add_location(button, file, 95, 8, 4095);
			attr_dev(div2, "class", "flex");
			add_location(div2, file, 94, 8, 4067);
			attr_dev(div3, "class", "flex justify-end my-8");
			add_location(div3, file, 93, 8, 4022);
			add_location(form, file, 63, 8, 2319);
			add_location(br4, file, 103, 12, 4376);
			attr_dev(div4, "id", "add_to_me");
			add_location(div4, file, 107, 8, 4398);
			attr_dev(div5, "class", " p-2");
			add_location(div5, file, 62, 4, 2291);
			attr_dev(div6, "class", "flex-initial w-2/3 p-2");
			add_location(div6, file, 58, 2, 2126);
