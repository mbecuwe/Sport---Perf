import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_each_argument, a as validate_slots, e as element, t as text, c as claim_element, f as children, j as claim_text, g as detach_dev, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as noop, b as space, h as claim_space, G as create_component, H as claim_component, I as toggle_class, J as mount_component, D as transition_in, E as transition_out, p as destroy_each, K as destroy_component } from './client.42f81d70.js';
import './moment.98d1f4f0.js';
import './Chart.d62ec9f6.js';
import Workoutpushups_radar from './workoutpushups-radar.6fb2cf7e.js';
import Workoutothers_radar from './workoutothers-radar.1b1b36a1.js';
import Workoutabdo_radar from './workoutabdo-radar.27a1702a.js';
import Workoutlegs_radar from './workoutlegs-radar.fcc6d0bf.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 462, 12, 15527);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 463, 12, 15588);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 464, 12, 15664);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 465, 12, 15740);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 466, 12, 15824);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 467, 12, 15908);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 468, 12, 15989);
			add_location(tr, file, 461, 12, 15510);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 516, 12, 17857);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 517, 12, 17918);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 518, 12, 17990);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 519, 12, 18062);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 520, 12, 18142);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 521, 12, 18222);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 522, 12, 18297);
			add_location(tr, file, 515, 12, 17840);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 420, 48, 13879);
