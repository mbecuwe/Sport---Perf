import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, F as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, G as destroy_each, B as destroy_component } from './client.ae6dddc2.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.3f789e72.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 138, 4, 3763);
		},
...
// (211:12) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 212, 12, 6063);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 213, 12, 6129);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 214, 12, 6186);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 215, 12, 6255);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 216, 12, 6348);
			add_location(tr, file, 211, 12, 6046);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(211:12) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 122, 4, 3387);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 121, 2, 3346);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 128, 4, 3573);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 127, 4, 3539);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 126, 2, 3498);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 120, 0, 3320);
			add_location(lu, file, 136, 4, 3699);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 134, 0, 3640);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 148, 8, 3906);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 149, 8, 3949);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 150, 8, 3990);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 151, 8, 4056);
			add_location(tr0, file, 147, 8, 3893);
			add_location(thead0, file, 146, 4, 3877);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 156, 8, 4174);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 157, 8, 4229);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 158, 8, 4287);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 159, 8, 4350);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 160, 8, 4416);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 161, 8, 4480);
			add_location(tr1, file, 155, 8, 4161);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 164, 8, 4594);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 165, 8, 4649);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 166, 8, 4704);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 167, 8, 4764);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 168, 8, 4827);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 169, 8, 4888);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 163, 8, 4561);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 172, 8, 4979);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 173, 8, 5035);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 174, 8, 5094);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 175, 8, 5158);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 176, 8, 5225);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 177, 8, 5290);
			add_location(tr3, file, 171, 8, 4966);
			add_location(tbody0, file, 154, 4, 4145);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 145, 4, 3833);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 144, 0, 3810);
			add_location(h3, file, 187, 1, 5428);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 186, 0, 5402);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 199, 12, 5667);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 200, 12, 5711);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 201, 12, 5763);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 202, 12, 5813);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 203, 12, 5865);
			add_location(tr4, file, 198, 12, 5650);
			add_location(thead1, file, 197, 8, 5630);
			add_location(tbody1, file, 208, 8, 5963);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 196, 8, 5582);
			add_location(div8, file, 195, 4, 5567);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 191, 0, 5504);
		},
		m: function mount(target, anchor) {
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
