import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.08be924e.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			form = claim_element(div17_nodes, "FORM", {});
			...
			button = claim_element(div14_nodes, "BUTTON", { type: true, class: true });
			...
			br4 = claim_element(div17_nodes, "BR", {});
			t26 = claim_space(div17_nodes);
			div16 = claim_element(div17_nodes, "DIV", { id: true });
		...
		h: function hydrate() {
			...
			add_location(label3, file, 159, 16, 6323);
			attr_dev(div7, "class", "flex w-1/2 m-2");
			add_location(div7, file, 158, 12, 6278);
			...
			add_location(input3, file, 163, 20, 6541);
			attr_dev(div8, "class", "flex w-1/2 m-2");
			add_location(div8, file, 162, 16, 6492);
			...
			add_location(input4, file, 166, 20, 6813);
			attr_dev(div9, "class", "flex w-1/2 m-2");
			add_location(div9, file, 165, 16, 6764);
			attr_dev(div10, "class", "flex");
			add_location(div10, file, 157, 12, 6247);
			add_location(br2, file, 170, 12, 7050);
			attr_dev(label4, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xs font-bold m-3");
			add_location(label4, file, 174, 16, 7106);
			...
			add_location(input5, file, 178, 20, 7312);
			attr_dev(div11, "class", "flex w-1/2 m-2");
			add_location(div11, file, 177, 16, 7263);
			...
			add_location(input6, file, 181, 20, 7578);
			attr_dev(div12, "class", "flex w-1/2 m-2");
			add_location(div12, file, 180, 16, 7529);
			attr_dev(div13, "class", "flex");
			add_location(div13, file, 173, 12, 7071);
			add_location(br3, file, 185, 12, 7809);
			...
			add_location(button, file, 190, 8, 7895);
			attr_dev(div14, "class", "flex");
			add_location(div14, file, 189, 8, 7868);
			attr_dev(div15, "class", "flex justify-center");
			add_location(div15, file, 188, 8, 7826);
			add_location(form, file, 120, 8, 4644);
			add_location(br4, file, 198, 12, 8176);
			attr_dev(div16, "id", "add_to_me");
			add_location(div16, file, 202, 8, 8194);
			attr_dev(div17, "class", " p-2");
			add_location(div17, file, 119, 4, 4617);
			attr_dev(div18, "class", "flex-initial w-2/3 p-2");
			add_location(div18, file, 115, 2, 4465);
			attr_dev(div19, "class", "flex ");
			add_location(div19, file, 107, 0, 4250);
		},
