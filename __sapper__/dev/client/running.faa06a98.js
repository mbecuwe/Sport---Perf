...
import Running_charts from './running-charts.868d5dc9.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 152, 12, 4625);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 219, 16, 7923);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 220, 16, 7994);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 221, 16, 8056);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 222, 16, 8130);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 223, 16, 8245);
			add_location(tr, file, 218, 16, 7901);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 138, 8, 3966);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 137, 4, 3930);
			...
			add_location(div1, file, 142, 8, 4184);
			attr_dev(div2, "class", "flex justify-center mb-16 bg-blue-700 border-2 border-gray-300 shadow-lg rounded-t-md");
			add_location(div2, file, 141, 4, 4075);
			attr_dev(h10, "class", "text-blue-800  mb-8 ");
			add_location(h10, file, 148, 8, 4417);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 150, 8, 4485);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 147, 4, 4389);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 159, 8, 4759);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 162, 12, 4938);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 165, 16, 5190);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 166, 16, 5242);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 167, 16, 5292);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 168, 16, 5367);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 164, 16, 5125);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 163, 12, 5069);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 173, 16, 5530);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 174, 16, 5594);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 175, 16, 5661);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 176, 16, 5750);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 177, 16, 5825);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 178, 16, 5915);
			add_location(tr1, file, 172, 16, 5508);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 181, 16, 6045);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 182, 16, 6109);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 183, 16, 6190);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 184, 16, 6276);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 185, 16, 6348);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 186, 16, 6435);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 180, 16, 6014);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 189, 16, 6553);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 190, 16, 6614);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 191, 16, 6682);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 192, 16, 6772);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 193, 16, 6848);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 194, 16, 6939);
			add_location(tr3, file, 188, 16, 6531);
			add_location(tbody0, file, 171, 12, 5483);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 161, 12, 4868);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 160, 8, 4818);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 203, 12, 7223);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 206, 16, 7466);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 207, 16, 7515);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 208, 16, 7572);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 209, 16, 7627);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 210, 16, 7684);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 205, 16, 7401);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 204, 12, 7345);
			add_location(tbody1, file, 215, 12, 7803);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 202, 12, 7153);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 201, 8, 7103);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 232, 12, 8473);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 231, 8, 8441);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 158, 4, 4721);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 146, 4, 4366);
			attr_dev(div10, "class", "mb-20 bg-white");
			add_location(div10, file, 135, 0, 3894);
		},
		m: function mount(target, anchor) {
