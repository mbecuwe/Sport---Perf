import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.49597153.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.2bfbcbb1.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t27 = claim_text(td10_nodes, "Elevation (m)");
			...
			t29 = claim_text(td11_nodes, /*last_elevation*/ ctx[3]);
		...
		h: function hydrate() {
			...
			add_location(td10, file, 128, 8, 3336);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 129, 8, 3392);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 130, 8, 3451);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 131, 16, 3523);
			add_location(tr3, file, 127, 8, 3323);
			...
			add_location(h3, file, 140, 1, 3616);
			add_location(div6, file, 139, 0, 3608);
		},
