...
import Running_charts from './running-charts.6a76e26e.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 152, 12, 4464);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 219, 16, 7706);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 220, 16, 7776);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 221, 16, 7837);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 222, 16, 7910);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 223, 16, 8024);
			add_location(tr, file, 218, 16, 7685);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h10, file, 148, 8, 4260);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 150, 8, 4326);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 147, 4, 4233);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 159, 8, 4591);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 162, 12, 4767);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 165, 16, 5016);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 166, 16, 5067);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 167, 16, 5116);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 168, 16, 5190);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 164, 16, 4952);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 163, 12, 4897);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 173, 16, 5348);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 174, 16, 5411);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 175, 16, 5477);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 176, 16, 5565);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 177, 16, 5639);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 178, 16, 5728);
			add_location(tr1, file, 172, 16, 5327);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 181, 16, 5866);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 182, 16, 5929);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 183, 16, 6009);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 184, 16, 6094);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 185, 16, 6165);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 186, 16, 6251);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 180, 16, 5825);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 189, 16, 6366);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 190, 16, 6426);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 191, 16, 6493);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 192, 16, 6582);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 193, 16, 6657);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 194, 16, 6747);
			add_location(tr3, file, 188, 16, 6345);
			add_location(tbody0, file, 171, 12, 5303);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 161, 12, 4698);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 160, 8, 4649);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 203, 12, 7022);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 206, 16, 7262);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 207, 16, 7310);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 208, 16, 7366);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 209, 16, 7420);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 210, 16, 7476);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 205, 16, 7198);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 204, 12, 7143);
			add_location(tbody1, file, 215, 12, 7590);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 202, 12, 6953);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 201, 8, 6904);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 232, 12, 8243);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 231, 8, 8212);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 158, 4, 4554);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 146, 4, 4211);
			attr_dev(div10, "class", "mb-20");
			add_location(div10, file, 135, 0, 3759);
		},
		m: function mount(target, anchor) {
