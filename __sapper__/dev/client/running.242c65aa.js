...
import Running_charts from './running-charts.38e5ea9f.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (img.src !== (img_src_value = "running3.jpg")) attr_dev(img, "src", img_src_value);
