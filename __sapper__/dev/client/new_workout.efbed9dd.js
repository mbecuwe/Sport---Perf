import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.48648259.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input3, file, 166, 20, 6606);
			attr_dev(div9, "class", "flex w-1/2 m-2");
			add_location(div9, file, 165, 16, 6557);
			...
			add_location(input5, file, 181, 20, 7377);
			attr_dev(div12, "class", "flex w-1/2 m-2");
			add_location(div12, file, 180, 16, 7328);
			...
			add_location(input6, file, 184, 20, 7643);
			attr_dev(div13, "class", "flex w-1/2 m-2");
			add_location(div13, file, 183, 16, 7594);
			attr_dev(div14, "class", "flex");
			add_location(div14, file, 176, 12, 7136);
			add_location(br3, file, 188, 12, 7874);
			...
			add_location(button, file, 193, 8, 7960);
			attr_dev(div15, "class", "flex");
			add_location(div15, file, 192, 8, 7933);
			attr_dev(div16, "class", "flex justify-center");
			add_location(div16, file, 191, 8, 7891);
			add_location(form, file, 120, 8, 4644);
			add_location(br4, file, 201, 12, 8241);
			attr_dev(div17, "id", "add_to_me");
			add_location(div17, file, 205, 8, 8259);
