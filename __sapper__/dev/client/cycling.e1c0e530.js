import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.54235fad.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.028a1c06.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(th1, "class", "px-4 py-2 col-span-2");
			add_location(th1, file, 107, 8, 2493);
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 108, 8, 2545);
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 109, 8, 2601);
			add_location(tr0, file, 105, 8, 2437);
			add_location(thead, file, 104, 4, 2421);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 114, 8, 2703);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 115, 8, 2758);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 116, 8, 2816);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 117, 16, 2887);
			add_location(tr1, file, 113, 8, 2690);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 120, 8, 2977);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 121, 8, 3032);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 122, 8, 3087);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 123, 16, 3155);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 119, 8, 2944);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 126, 8, 3225);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 127, 8, 3281);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 128, 8, 3340);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 129, 16, 3412);
			add_location(tr3, file, 125, 8, 3212);
			add_location(tbody, file, 112, 4, 2674);
			...
			add_location(h3, file, 138, 1, 3505);
			add_location(div6, file, 137, 0, 3497);
		},
