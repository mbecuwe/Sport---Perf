import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.42cbfa72.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Running_charts from './running-charts.666ba4e0.js';
...
// (148:8) {#each get_last_nb_sessions(3, list_date) as date}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 148, 8, 4279);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(148:8) {#each get_last_nb_sessions(3, list_date) as date}",
		ctx
	});
...
// (215:16) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 216, 16, 6914);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 217, 16, 6985);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 218, 16, 7047);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 219, 16, 7121);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 220, 16, 7236);
			add_location(tr, file, 215, 16, 6892);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(215:16) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(lu, file, 146, 8, 4205);
			attr_dev(div3, "class", "px-10");
			add_location(div3, file, 144, 4, 4136);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 158, 12, 4464);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 159, 12, 4512);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 160, 12, 4558);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 161, 12, 4629);
			add_location(tr0, file, 157, 12, 4446);
			add_location(thead0, file, 156, 8, 4425);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 166, 12, 4772);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 167, 12, 4832);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 168, 12, 4895);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 169, 12, 4980);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 170, 12, 5051);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 171, 12, 5137);
			add_location(tr1, file, 165, 12, 4754);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 174, 12, 5266);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 175, 12, 5326);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 176, 12, 5403);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 177, 12, 5485);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 178, 12, 5553);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 179, 12, 5636);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 173, 12, 5228);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 182, 12, 5742);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 183, 12, 5799);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 184, 12, 5863);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 185, 12, 5949);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 186, 12, 6021);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 187, 12, 6108);
			add_location(tr3, file, 181, 12, 5724);
			add_location(tbody0, file, 164, 8, 4733);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 155, 8, 4376);
			attr_dev(div4, "class", "p-10");
			add_location(div4, file, 154, 4, 4348);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 203, 16, 6457);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 204, 16, 6506);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 205, 16, 6563);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 206, 16, 6618);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 207, 16, 6675);
			add_location(tr4, file, 202, 16, 6435);
			add_location(thead1, file, 201, 12, 6410);
			add_location(tbody1, file, 212, 12, 6794);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 200, 12, 6357);
			attr_dev(div5, "class", "py-5");
			add_location(div5, file, 199, 8, 6325);
			attr_dev(div6, "class", "px-10 py-5");
			add_location(div6, file, 196, 4, 6252);
			add_location(h3, file, 234, 8, 7482);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 233, 4, 7448);
			attr_dev(div8, "class", "mb-20");
			add_location(div8, file, 130, 0, 3668);
		},
		m: function mount(target, anchor) {
