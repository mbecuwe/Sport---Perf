import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.27b3cf93.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.bb9bfd63.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 145, 4, 4094);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 213, 12, 6481);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 214, 12, 6548);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 215, 12, 6606);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 216, 12, 6676);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 217, 12, 6787);
			add_location(tr, file, 212, 12, 6463);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "text-center p-2 text-2xl text-blue-800 font-semibold bg-blue-100 border-2 border-gray-300 shadow-sm");
			...
			add_location(img, file, 135, 4, 3894);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 134, 4, 3859);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 133, 2, 3817);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 127, 0, 3573);
			add_location(lu, file, 143, 4, 4028);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 141, 0, 3967);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 155, 8, 4247);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 156, 8, 4291);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 157, 8, 4333);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 158, 8, 4400);
			add_location(tr0, file, 154, 8, 4233);
			add_location(thead0, file, 153, 4, 4216);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 163, 8, 4523);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 164, 8, 4579);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 165, 8, 4638);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 166, 8, 4714);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 167, 8, 4781);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 168, 8, 4863);
			add_location(tr1, file, 162, 8, 4509);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 171, 8, 4980);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 172, 8, 5036);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 173, 8, 5109);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 174, 8, 5187);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 175, 8, 5251);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 176, 8, 5330);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 170, 8, 4946);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 179, 8, 5424);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 180, 8, 5477);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 181, 8, 5537);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 182, 8, 5619);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 183, 8, 5687);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 184, 8, 5770);
			add_location(tr3, file, 178, 8, 5410);
			add_location(tbody0, file, 161, 4, 4492);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 152, 4, 4171);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 151, 0, 4147);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 200, 12, 6072);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 201, 12, 6117);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 202, 12, 6170);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 203, 12, 6221);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 204, 12, 6274);
			add_location(tr4, file, 199, 12, 6054);
			add_location(thead1, file, 198, 8, 6033);
			add_location(tbody1, file, 209, 8, 6377);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 197, 8, 5984);
			attr_dev(div7, "class", "py-5");
			add_location(div7, file, 196, 4, 5956);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 193, 0, 5891);
			add_location(h3, file, 231, 1, 6994);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 230, 0, 6967);
		},
		m: function mount(target, anchor) {
