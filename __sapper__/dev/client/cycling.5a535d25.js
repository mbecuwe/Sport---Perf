import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.877daf5a.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.757476a6.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 16, 7528);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 16, 7599);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 16, 7661);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 16, 7735);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 16, 7850);
			add_location(tr, file, 210, 16, 7506);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th4, file, 198, 16, 7071);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 16, 7120);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 16, 7177);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 16, 7232);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 16, 7289);
			...
			add_location(tbody1, file, 207, 12, 7408);
			...
			add_location(h12, file, 227, 12, 8084);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 226, 8, 8052);
