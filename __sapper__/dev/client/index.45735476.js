...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 139, 4, 3359);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 140, 4, 3441);
			add_location(tr, file, 138, 4, 3350);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th, file, 132, 4, 3191);
			...
			add_location(tbody, file, 135, 6, 3290);
