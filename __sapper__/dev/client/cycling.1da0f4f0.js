import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.9c3f3505.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.b1da9bbc.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 149, 4, 4191);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 217, 12, 6578);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 218, 12, 6645);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 219, 12, 6703);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 220, 12, 6773);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 221, 12, 6884);
			add_location(tr, file, 216, 12, 6560);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img0, "class", "object-contain h-48 w-full");
			...
			add_location(div1, file, 133, 4, 3737);
			attr_dev(div2, "class", "flex-initial w-2/3 p-2");
			add_location(div2, file, 132, 2, 3695);
			if (img1.src !== (img1_src_value = "cycling.jpg")) attr_dev(img1, "src", img1_src_value);
			attr_dev(img1, "alt", "cycling");
			add_location(img1, file, 139, 4, 3991);
			attr_dev(div3, "class", " text-right p-2");
			add_location(div3, file, 138, 4, 3956);
			attr_dev(div4, "class", "flex-initial w-1/3 p-2");
			add_location(div4, file, 137, 2, 3912);
			attr_dev(div5, "class", "flex h-48");
			add_location(div5, file, 131, 0, 3668);
			add_location(lu, file, 147, 4, 4125);
			attr_dev(div6, "class", "px-10");
			add_location(div6, file, 145, 0, 4064);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 159, 8, 4344);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 160, 8, 4388);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 161, 8, 4430);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 162, 8, 4497);
			add_location(tr0, file, 158, 8, 4330);
			add_location(thead0, file, 157, 4, 4313);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 167, 8, 4620);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 168, 8, 4676);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 169, 8, 4735);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 170, 8, 4811);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 171, 8, 4878);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 172, 8, 4960);
			add_location(tr1, file, 166, 8, 4606);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 175, 8, 5077);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 176, 8, 5133);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 177, 8, 5206);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 178, 8, 5284);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 179, 8, 5348);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 180, 8, 5427);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 174, 8, 5043);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 183, 8, 5521);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 184, 8, 5574);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 185, 8, 5634);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 186, 8, 5716);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 187, 8, 5784);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 188, 8, 5867);
			add_location(tr3, file, 182, 8, 5507);
			add_location(tbody0, file, 165, 4, 4589);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 156, 4, 4268);
			attr_dev(div7, "class", "p-10");
			add_location(div7, file, 155, 0, 4244);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 204, 12, 6169);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 205, 12, 6214);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 206, 12, 6267);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 207, 12, 6318);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 208, 12, 6371);
			add_location(tr4, file, 203, 12, 6151);
			add_location(thead1, file, 202, 8, 6130);
			add_location(tbody1, file, 213, 8, 6474);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 201, 8, 6081);
			attr_dev(div8, "class", "py-5");
			add_location(div8, file, 200, 4, 6053);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 197, 0, 5988);
			add_location(h3, file, 235, 1, 7091);
			attr_dev(div10, "class", "px-10 py-5");
			add_location(div10, file, 234, 0, 7064);
		},
		m: function mount(target, anchor) {
