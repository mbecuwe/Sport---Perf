...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(label0, "class", " text-center block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			...
			add_location(input0, file, 73, 8, 2617);
			...
			add_location(button, file, 92, 8, 3926);
			add_location(form, file, 63, 8, 2242);
			add_location(br4, file, 95, 12, 4158);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4176);
