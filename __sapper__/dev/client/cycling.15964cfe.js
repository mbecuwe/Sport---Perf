...
import Cycling_charts from './cycling-charts.cdbd1b20.js';
...
// (154:12) {#each get_last_nb_sessions(3, list_date) as date}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 154, 12, 4499);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(154:12) {#each get_last_nb_sessions(3, list_date) as date}",
		ctx
	});
...
// (221:16) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 222, 16, 7726);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 223, 16, 7796);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 224, 16, 7857);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 225, 16, 7930);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 226, 16, 8044);
			add_location(tr, file, 221, 16, 7705);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(221:16) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 139, 8, 3874);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 138, 4, 3839);
			...
			add_location(div1, file, 144, 8, 4089);
			attr_dev(div2, "class", "flex justify-center mb-16 bg-blue-700 border-2 border-gray-300 shadow-lg rounded-t-md");
			add_location(div2, file, 143, 4, 3981);
			attr_dev(h10, "class", "text-blue-800  mb-8 ");
			add_location(h10, file, 150, 8, 4295);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 152, 8, 4361);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 149, 4, 4268);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 160, 8, 4625);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 163, 12, 4801);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 166, 16, 5050);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 167, 16, 5101);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 168, 16, 5150);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 169, 16, 5224);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 165, 16, 4986);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 164, 12, 4931);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 174, 16, 5382);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 175, 16, 5445);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 176, 16, 5511);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 177, 16, 5594);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 178, 16, 5668);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 179, 16, 5757);
			add_location(tr1, file, 173, 16, 5361);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 182, 16, 5884);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 183, 16, 5947);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 184, 16, 6027);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 185, 16, 6112);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 186, 16, 6183);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 187, 16, 6269);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 181, 16, 5854);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 190, 16, 6384);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 191, 16, 6444);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 192, 16, 6511);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 193, 16, 6600);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 194, 16, 6675);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 195, 16, 6765);
			add_location(tr3, file, 189, 16, 6363);
			add_location(tbody0, file, 172, 12, 5337);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 162, 12, 4732);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 161, 8, 4683);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 206, 12, 7042);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 209, 16, 7282);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 210, 16, 7330);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 211, 16, 7386);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 212, 16, 7440);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 213, 16, 7496);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 208, 16, 7218);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 207, 12, 7163);
			add_location(tbody1, file, 218, 12, 7610);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 205, 12, 6973);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 204, 8, 6924);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 235, 12, 8263);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 234, 8, 8232);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 159, 4, 4588);
			attr_dev(div9, "class", "mb-20");
			add_location(div9, file, 137, 0, 3815);
		},
		m: function mount(target, anchor) {
