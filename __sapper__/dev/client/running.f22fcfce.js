...
import Running_charts from './running-charts.5a676f44.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 217, 12, 7611);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 218, 12, 7678);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 219, 12, 7736);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 220, 12, 7806);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 221, 12, 7917);
			add_location(tr, file, 216, 12, 7593);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(caption0, file, 157, 12, 4671);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 160, 16, 4923);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 161, 16, 4975);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 162, 16, 5025);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 163, 16, 5100);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 159, 16, 4858);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 158, 12, 4802);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 168, 16, 5263);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 169, 16, 5327);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 170, 16, 5394);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 171, 16, 5483);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 172, 16, 5558);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 173, 16, 5648);
			add_location(tr1, file, 167, 16, 5241);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 176, 16, 5789);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 177, 16, 5853);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 178, 16, 5934);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 179, 16, 6020);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 180, 16, 6092);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 181, 16, 6179);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 175, 16, 5747);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 184, 16, 6297);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 185, 16, 6358);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 186, 16, 6426);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 187, 16, 6516);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 188, 16, 6592);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 189, 16, 6683);
			add_location(tr3, file, 183, 16, 6275);
			add_location(tbody0, file, 166, 12, 5216);
			...
			add_location(caption1, file, 201, 8, 6971);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 204, 12, 7202);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 205, 12, 7247);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 206, 12, 7300);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 207, 12, 7351);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 208, 12, 7404);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 203, 12, 7141);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 202, 8, 7089);
			add_location(tbody1, file, 213, 8, 7507);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 200, 8, 6905);
			attr_dev(div7, "class", "m-12 container mx-auto");
			add_location(div7, file, 199, 4, 6859);
			add_location(h3, file, 232, 8, 8123);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 231, 4, 8089);
