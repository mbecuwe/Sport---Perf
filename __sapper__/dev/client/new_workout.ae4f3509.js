import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.e1fb3faa.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 160, 8, 6294);
			attr_dev(div7, "class", "flex");
			add_location(div7, file, 159, 8, 6267);
			attr_dev(div8, "class", "flexjustify-center");
			add_location(div8, file, 158, 8, 6226);
			add_location(form, file, 120, 8, 4644);
			add_location(br1, file, 168, 12, 6575);
			attr_dev(div9, "id", "add_to_me");
			add_location(div9, file, 172, 8, 6593);
