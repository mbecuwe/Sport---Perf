import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.8f627f22.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.63260bb4.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 16, 7422);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 16, 7493);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 16, 7555);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 16, 7629);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 16, 7744);
			add_location(tr, file, 210, 16, 7400);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th4, file, 198, 16, 6965);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 16, 7014);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 16, 7071);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 16, 7126);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 16, 7183);
			add_location(tr4, file, 197, 16, 6943);
			add_location(thead1, file, 196, 12, 6918);
			add_location(tbody1, file, 207, 12, 7302);
			...
			add_location(h12, file, 227, 12, 7978);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 226, 8, 7946);
