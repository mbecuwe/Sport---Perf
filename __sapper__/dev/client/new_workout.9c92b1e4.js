import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.7c725a05.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t11 = claim_text(label2_nodes, "Distance (m)");
			...
			t15 = claim_text(label3_nodes, "Distance (m)");
			...
			t19 = claim_text(label4_nodes, "Distance (m)");
			...
			t23 = claim_text(label5_nodes, "Distance (m)");
			...
			t27 = claim_text(label6_nodes, "Minutes");
			...
			t31 = claim_text(label7_nodes, "Elevation (m)");
			...
			t35 = claim_text(button_nodes, "Add Session");
		...
		h: function hydrate() {
			...
			add_location(label1, file, 135, 8, 5231);
			...
			add_location(input5, file, 154, 8, 6804);
			add_location(br5, file, 155, 12, 7012);
			attr_dev(label6, "for", "minutes");
			attr_dev(label6, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label6, file, 157, 8, 7028);
			attr_dev(input6, "placeholder", "minutes");
			...
			add_location(input6, file, 159, 8, 7160);
			add_location(br6, file, 160, 12, 7371);
			attr_dev(label7, "for", "elevation");
			attr_dev(label7, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label7, file, 162, 8, 7387);
			attr_dev(input7, "placeholder", "elevation");
			...
			add_location(input7, file, 164, 8, 7527);
			add_location(br7, file, 165, 12, 7744);
			...
			add_location(button, file, 167, 8, 7760);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 170, 12, 7992);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 174, 8, 8010);
			attr_dev(div3, "class", " p-2");
			add_location(div3, file, 119, 4, 4612);
			attr_dev(div4, "class", "flex-initial w-2/3 p-2");
			add_location(div4, file, 115, 2, 4465);
			attr_dev(div5, "class", "flex ");
			add_location(div5, file, 107, 0, 4250);
		},
		m: function mount(target, anchor, remount) {
			...
			set_input_value(input6, /*minutes*/ ctx[2]);
			append_dev(form, t29);
			append_dev(form, br6);
			append_dev(form, t30);
			...
			set_input_value(input7, /*elevation*/ ctx[3]);
			append_dev(form, t33);
			append_dev(form, br7);
			append_dev(form, t34);
			append_dev(form, button);
			append_dev(button, t35);
			append_dev(div3, t36);
			append_dev(div3, br8);
			append_dev(div3, t37);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty[0] & /*minutes*/ 4 && to_number(input6.value) !== /*minutes*/ ctx[2]) {
				set_input_value(input6, /*minutes*/ ctx[2]);
			}

			if (dirty[0] & /*elevation*/ 8 && to_number(input7.value) !== /*elevation*/ ctx[3]) {
				set_input_value(input7, /*elevation*/ ctx[3]);
			}
		},
		i: noop,
