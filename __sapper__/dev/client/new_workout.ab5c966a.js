...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label0, file, 163, 16, 6400);
			attr_dev(div4, "class", "flex w-1/3 m-2");
			add_location(div4, file, 162, 12, 6355);
			...
			add_location(input0, file, 168, 21, 6631);
			attr_dev(div5, "class", "flex w-2/3 m-2");
			add_location(div5, file, 167, 16, 6581);
			attr_dev(div6, "class", "flex");
			add_location(div6, file, 161, 12, 6324);
			add_location(br0, file, 171, 12, 6879);
			attr_dev(label1, "class", "block uppercase tracking-wide  text-grey-darker text-xs font-bold p-2");
			add_location(label1, file, 176, 20, 6984);
			attr_dev(div7, "class", "flex w-1/2 m-2");
			add_location(div7, file, 175, 16, 6935);
			...
			add_location(input1, file, 180, 20, 7199);
			attr_dev(div8, "class", "flex w-1/2 m-2");
			add_location(div8, file, 179, 16, 7150);
			...
			add_location(input3, file, 196, 20, 8137);
			attr_dev(div12, "class", "flex w-1/2 m-2");
			add_location(div12, file, 195, 16, 8088);
			...
			add_location(input5, file, 209, 20, 8936);
			attr_dev(div16, "class", "flex w-1/2 m-2");
			add_location(div16, file, 208, 16, 8887);
			...
			add_location(input7, file, 222, 20, 9747);
			attr_dev(div20, "class", "flex w-1/2 m-2");
			add_location(div20, file, 221, 16, 9698);
			...
			add_location(input9, file, 235, 20, 10567);
			attr_dev(div24, "class", "flex w-1/2 m-2");
			add_location(div24, file, 234, 16, 10518);
			...
			add_location(input11, file, 256, 20, 11533);
			attr_dev(div28, "class", "flex w-1/2 m-2");
			add_location(div28, file, 255, 16, 11484);
			...
			add_location(input13, file, 274, 20, 12346);
			attr_dev(div32, "class", "flex w-1/2 m-2");
			add_location(div32, file, 273, 16, 12297);
			...
			add_location(input15, file, 289, 20, 13184);
			attr_dev(div36, "class", "flex w-1/2 m-2");
			add_location(div36, file, 288, 16, 13135);
			...
			add_location(input17, file, 302, 20, 13996);
			attr_dev(div40, "class", "flex w-1/2 m-2");
			add_location(div40, file, 301, 16, 13947);
			...
			add_location(input19, file, 315, 20, 14807);
			attr_dev(div44, "class", "flex w-1/2 m-2");
			add_location(div44, file, 314, 16, 14758);
			...
			add_location(input21, file, 334, 20, 15783);
			attr_dev(div48, "class", "flex w-1/2 m-2");
			add_location(div48, file, 333, 16, 15734);
			...
			add_location(input23, file, 347, 20, 16583);
			attr_dev(div52, "class", "flex w-1/2 m-2");
			add_location(div52, file, 346, 16, 16534);
			...
			add_location(input25, file, 360, 20, 17408);
			attr_dev(div56, "class", "flex w-1/2 m-2");
			add_location(div56, file, 359, 16, 17359);
			...
			add_location(input27, file, 379, 20, 18378);
			attr_dev(div60, "class", "flex w-1/2 m-2");
			add_location(div60, file, 378, 16, 18329);
			...
			add_location(input29, file, 392, 20, 19176);
			attr_dev(div64, "class", "flex w-1/2 m-2");
			add_location(div64, file, 391, 16, 19127);
			...
			add_location(input31, file, 405, 20, 19997);
			attr_dev(div68, "class", "flex w-1/2 m-2");
			add_location(div68, file, 404, 16, 19948);
			...
			add_location(input32, file, 408, 20, 20264);
			attr_dev(div69, "class", "flex w-1/2 m-2");
			add_location(div69, file, 407, 16, 20215);
			attr_dev(div70, "class", "flex");
			add_location(div70, file, 399, 12, 19699);
			...
			add_location(button, file, 416, 8, 20570);
			attr_dev(div71, "class", "flex");
			add_location(div71, file, 415, 8, 20543);
			attr_dev(div72, "class", "flex justify-end mx-2 my-8");
			add_location(div72, file, 414, 8, 20494);
			add_location(form, file, 154, 8, 6102);
			add_location(br4, file, 424, 12, 20851);
			attr_dev(div73, "id", "add_to_me");
			add_location(div73, file, 428, 8, 20869);
			attr_dev(div74, "class", " p-2");
			add_location(div74, file, 153, 4, 6075);
			attr_dev(div75, "class", "flex-initial p-2");
			add_location(div75, file, 152, 2, 6040);
