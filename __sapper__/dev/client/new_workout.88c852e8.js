import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.63d0f1ef.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t6 = claim_text(label1_nodes, "Legs");
			...
			t8 = claim_text(label2_nodes, "Squats");
			...
			t13 = claim_text(label3_nodes, "Distance (m)");
			...
			t29 = claim_text(label7_nodes, "Minutes");
			...
			t33 = claim_text(label8_nodes, "Elevation (m)");
			...
			t37 = claim_text(button_nodes, "Add Session");
		...
		h: function hydrate() {
			...
			add_location(input1, file, 145, 20, 5723);
			attr_dev(div4, "class", "flex w-1/2 m-3");
			add_location(div4, file, 144, 16, 5674);
			...
			add_location(input8, file, 186, 8, 8203);
			add_location(br6, file, 187, 12, 8420);
			...
			add_location(button, file, 189, 8, 8436);
			add_location(form, file, 120, 8, 4644);
			add_location(br7, file, 192, 12, 8668);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 196, 8, 8686);
