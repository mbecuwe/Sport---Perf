import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.42696a6c.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.78e774b6.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(th2, "class", "px-4 py-2 col-span-2");
			...
			add_location(td0, file, 114, 8, 2702);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 115, 8, 2757);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 116, 8, 2815);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 117, 16, 2886);
			add_location(tr1, file, 113, 8, 2689);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 120, 8, 2976);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 121, 8, 3031);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 122, 8, 3086);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 123, 16, 3154);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 119, 8, 2943);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 126, 8, 3224);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 127, 8, 3280);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 128, 8, 3339);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 129, 16, 3411);
			add_location(tr3, file, 125, 8, 3211);
			add_location(tbody, file, 112, 4, 2673);
			...
			add_location(h3, file, 138, 1, 3504);
			add_location(div6, file, 137, 0, 3496);
		},
