import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.d11f01be.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input1, file, 24, 20, 618);
			option0.__value = "Fitness";
			option0.value = option0.__value;
			add_location(option0, file, 26, 24, 774);
			option1.__value = "Jogging";
			option1.value = option1.__value;
			add_location(option1, file, 27, 24, 832);
			option2.__value = "Swimming";
			option2.value = option2.__value;
			add_location(option2, file, 28, 24, 890);
			option3.__value = "Racing Bike";
			option3.value = option3.__value;
			add_location(option3, file, 29, 24, 949);
			attr_dev(datalist0, "id", "sports");
			add_location(datalist0, file, 25, 20, 727);
			attr_dev(div2, "class", "pb-6");
			add_location(div2, file, 22, 16, 532);
			attr_dev(p2, "class", "pb-2");
			add_location(p2, file, 33, 20, 1097);
			...
			add_location(input2, file, 34, 20, 1146);
			option4.__value = "Biceps";
			option4.value = option4.__value;
			add_location(option4, file, 36, 24, 1314);
			option5.__value = "Chest";
			option5.value = option5.__value;
			add_location(option5, file, 37, 24, 1371);
			option6.__value = "Core";
			option6.value = option6.__value;
			add_location(option6, file, 38, 24, 1427);
			option7.__value = "Quads";
			option7.value = option7.__value;
			add_location(option7, file, 39, 24, 1482);
			option8.__value = "Shoulders";
			option8.value = option8.__value;
			add_location(option8, file, 40, 24, 1538);
			option9.__value = "Back";
			option9.value = option9.__value;
			add_location(option9, file, 41, 24, 1598);
			option10.__value = "Triceps";
			option10.value = option10.__value;
			add_location(option10, file, 42, 24, 1653);
			option11.__value = "Glutes";
			option11.value = option11.__value;
			add_location(option11, file, 43, 24, 1711);
			attr_dev(datalist1, "id", "exercices");
			add_location(datalist1, file, 35, 20, 1264);
			attr_dev(div3, "class", "pb-6");
			add_location(div3, file, 32, 16, 1058);
			attr_dev(p3, "class", "pb-2");
			add_location(p3, file, 47, 20, 1854);
			...
			add_location(input3, file, 48, 20, 1902);
			attr_dev(div4, "class", "pb-6");
			add_location(div4, file, 46, 16, 1815);
			attr_dev(div5, "class", "md:flex mt-12 w-full justify-around");
			add_location(div5, file, 17, 12, 268);
			attr_dev(div6, "class", "mx-5 my-5");
			add_location(div6, file, 13, 8, 86);
			attr_dev(body, "class", "bg-blue-100 w-screen h-screen");
			add_location(body, file, 12, 4, 33);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
