...
import Cycling_charts from './cycling-charts.82628264.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img0, "class", "object-fill h-48 w-full");
