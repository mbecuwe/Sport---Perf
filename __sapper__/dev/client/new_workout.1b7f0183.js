import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.d105063a.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t10 = claim_text(label2_nodes, "Distance (m)");
		...
		h: function hydrate() {
			...
			add_location(input1, file, 136, 8, 5423);
			attr_dev(div2, "class", "flex w-1/2");
			add_location(div2, file, 133, 16, 5254);
			attr_dev(label2, "for", "meters");
			attr_dev(label2, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label2, file, 142, 8, 5691);
			...
			add_location(input8, file, 182, 8, 8038);
			add_location(br7, file, 183, 12, 8255);
			...
			add_location(button, file, 185, 8, 8271);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 188, 12, 8503);
			attr_dev(div5, "id", "add_to_me");
			add_location(div5, file, 192, 8, 8521);
