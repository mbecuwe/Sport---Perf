import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.a10ccd2f.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.6fb7afe3.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 82, 4, 1937);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 81, 2, 1896);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 88, 4, 2123);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 87, 4, 2089);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 86, 2, 2048);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 80, 0, 1870);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 99, 8, 2287);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 100, 8, 2330);
			attr_dev(th2, "class", "px-4 py-2");
			add_location(th2, file, 101, 8, 2371);
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 102, 8, 2426);
			add_location(tr0, file, 98, 8, 2274);
			add_location(thead, file, 97, 4, 2258);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 107, 8, 2528);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 108, 8, 2583);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 109, 8, 2641);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 110, 16, 2692);
			add_location(tr1, file, 106, 8, 2515);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 113, 8, 2782);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 114, 8, 2837);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 115, 8, 2892);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 116, 16, 2943);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 112, 8, 2749);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 119, 8, 3013);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 120, 8, 3069);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 121, 8, 3128);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 122, 16, 3179);
			add_location(tr3, file, 118, 8, 3000);
			add_location(tbody, file, 105, 4, 2499);
			attr_dev(table, "class", "table-auto text-center ");
			add_location(table, file, 96, 4, 2214);
			attr_dev(div5, "class", "p-10");
			add_location(div5, file, 95, 0, 2191);
			attr_dev(h3, "class", "px-10 py-5");
			add_location(h3, file, 131, 1, 3272);
			add_location(div6, file, 130, 0, 3264);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	console.log(average_3_distance);
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
