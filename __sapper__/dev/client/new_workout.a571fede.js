import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.b6d718f7.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(label1, "class", "block uppercase p-4 tracking-wide text-grey-darker text-xl font-bold mb-2");
			...
			add_location(input1, file, 141, 20, 5605);
			attr_dev(div2, "class", "flex w-1/2 m-3");
			add_location(div2, file, 140, 16, 5556);
			...
			add_location(input8, file, 182, 8, 8085);
			add_location(br7, file, 183, 12, 8302);
			...
			add_location(button, file, 185, 8, 8318);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 188, 12, 8550);
			attr_dev(div5, "id", "add_to_me");
			add_location(div5, file, 192, 8, 8568);
