...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file, 92, 8, 3920);
			add_location(form, file, 63, 8, 2237);
			add_location(br4, file, 95, 12, 4152);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4170);
