...
import Swimming_charts from './swimming-charts.90aada60.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 213, 16, 7504);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 214, 16, 7575);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 215, 16, 7637);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 216, 16, 7711);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 217, 16, 7826);
			add_location(tr, file, 212, 16, 7482);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(caption0, file, 154, 12, 4521);
			...
			add_location(caption1, file, 197, 12, 6799);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 200, 16, 7053);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 201, 16, 7102);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 202, 16, 7159);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 203, 16, 7214);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 204, 16, 7271);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 199, 16, 6988);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 198, 12, 6932);
			add_location(tbody1, file, 209, 12, 7384);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 196, 12, 6729);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 195, 8, 6679);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 226, 12, 8051);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 225, 8, 8019);
