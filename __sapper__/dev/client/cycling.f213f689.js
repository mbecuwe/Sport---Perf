import { S as SvelteComponentDev, i as init, d as dispatch_dev, F as globals, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.6b3bb835.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.ccd4a601.js';
...
function create_fragment(ctx) {
	...
	let t16;
	let td3;
	let t17_value = (/*last_distance*/ ctx[1] - /*average_3_distance*/ ctx[4]) / /*average_3_distance*/ ctx[4] * 100 + "";
	let t17;
	let t18;
	let t19;
	let td4;
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td4, file, 118, 8, 2991);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 119, 8, 3034);
			add_location(tr1, file, 113, 8, 2699);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 122, 8, 3124);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 123, 8, 3179);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 124, 8, 3234);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 125, 16, 3302);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 126, 16, 3353);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 127, 16, 3404);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 121, 8, 3091);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 130, 8, 3474);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 131, 8, 3530);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 132, 8, 3589);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 133, 16, 3661);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 134, 16, 3712);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 135, 16, 3763);
			add_location(tr3, file, 129, 8, 3461);
			...
			add_location(h3, file, 144, 1, 3856);
			add_location(div6, file, 143, 0, 3848);
		},
