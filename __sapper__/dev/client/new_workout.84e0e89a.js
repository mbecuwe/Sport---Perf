import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.602ed96d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label3, file, 158, 16, 6294);
			...
			add_location(input3, file, 162, 20, 6506);
			attr_dev(div7, "class", "flex w-1/2 m-2");
			add_location(div7, file, 161, 16, 6457);
			...
			add_location(input4, file, 165, 20, 6778);
			attr_dev(div8, "class", "flex w-1/2 m-2");
			add_location(div8, file, 164, 16, 6729);
			attr_dev(div9, "class", "flex");
			add_location(div9, file, 157, 24, 6259);
			add_location(br2, file, 169, 12, 7015);
			attr_dev(label4, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xs font-bold m-3");
			add_location(label4, file, 173, 16, 7083);
			...
			add_location(input5, file, 177, 20, 7289);
			attr_dev(div10, "class", "flex w-1/2 m-2");
			add_location(div10, file, 176, 16, 7240);
			...
			add_location(input6, file, 180, 20, 7555);
			attr_dev(div11, "class", "flex w-1/2 m-2");
			add_location(div11, file, 179, 16, 7506);
			attr_dev(div12, "class", "flex");
			add_location(div12, file, 172, 12, 7048);
			add_location(br3, file, 184, 12, 7786);
			...
			add_location(button, file, 189, 8, 7872);
			attr_dev(div13, "class", "flex");
			add_location(div13, file, 188, 8, 7845);
			attr_dev(div14, "class", "flex justify-center");
			add_location(div14, file, 187, 8, 7803);
			add_location(form, file, 120, 8, 4644);
			add_location(br4, file, 197, 12, 8153);
			attr_dev(div15, "id", "add_to_me");
			add_location(div15, file, 201, 8, 8171);
