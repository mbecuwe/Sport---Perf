import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.6259ea65.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.4cdd0725.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(thead0, file, 135, 4, 3552);
			...
			add_location(tbody0, file, 143, 4, 3820);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 134, 4, 3508);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 133, 0, 3485);
			add_location(h3, file, 176, 1, 5103);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 175, 0, 5077);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 188, 8, 5315);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 189, 8, 5358);
			attr_dev(th6, "colspan", "2");
			attr_dev(th6, "class", "px-4 py-2 ");
			add_location(th6, file, 190, 8, 5399);
			attr_dev(th7, "colspan", "2");
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 191, 8, 5465);
			add_location(tr4, file, 187, 8, 5302);
			add_location(thead1, file, 186, 4, 5286);
			attr_dev(td18, "class", "border px-4 py-2");
			add_location(td18, file, 196, 8, 5583);
			attr_dev(td19, "class", "border px-4 py-2");
			add_location(td19, file, 197, 8, 5638);
			attr_dev(td20, "class", "border px-4 py-2");
			add_location(td20, file, 198, 8, 5696);
			attr_dev(td21, "class", "border px-4 py-2");
			add_location(td21, file, 199, 8, 5759);
			attr_dev(td22, "class", "border px-4 py-2");
			add_location(td22, file, 200, 8, 5825);
			attr_dev(td23, "class", "border px-4 py-2");
			add_location(td23, file, 201, 8, 5889);
			add_location(tr5, file, 195, 8, 5570);
			attr_dev(td24, "class", "border px-4 py-2");
			add_location(td24, file, 204, 8, 6003);
			attr_dev(td25, "class", "border px-4 py-2");
			add_location(td25, file, 205, 8, 6058);
			attr_dev(td26, "class", "border px-4 py-2");
			add_location(td26, file, 206, 8, 6113);
			attr_dev(td27, "class", "border px-4 py-2");
			add_location(td27, file, 207, 8, 6173);
			attr_dev(td28, "class", "border px-4 py-2");
			add_location(td28, file, 208, 8, 6236);
			attr_dev(td29, "class", "border px-4 py-2");
			add_location(td29, file, 209, 8, 6297);
			attr_dev(tr6, "class", "bg-gray-100");
			add_location(tr6, file, 203, 8, 5970);
			attr_dev(td30, "class", "border px-4 py-2");
			add_location(td30, file, 212, 8, 6388);
			attr_dev(td31, "class", "border px-4 py-2");
			add_location(td31, file, 213, 8, 6444);
			attr_dev(td32, "class", "border px-4 py-2");
			add_location(td32, file, 214, 8, 6503);
			attr_dev(td33, "class", "border px-4 py-2");
			add_location(td33, file, 215, 8, 6567);
			attr_dev(td34, "class", "border px-4 py-2");
			add_location(td34, file, 216, 8, 6634);
			attr_dev(td35, "class", "border px-4 py-2");
			add_location(td35, file, 217, 8, 6699);
			add_location(tr7, file, 211, 8, 6375);
			add_location(tbody1, file, 194, 4, 5554);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 185, 4, 5242);
			attr_dev(div8, "class", "p-10");
			add_location(div8, file, 184, 0, 5219);
			add_location(div9, file, 180, 0, 5179);
		},
