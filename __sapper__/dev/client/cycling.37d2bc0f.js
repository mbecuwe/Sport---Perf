...
import Cycling_charts from './cycling-charts.35ce533c.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 149, 12, 4535);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 217, 16, 7830);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 218, 16, 7901);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 219, 16, 7963);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 220, 16, 8037);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 221, 16, 8152);
			add_location(tr, file, 216, 16, 7808);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 134, 8, 3873);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 133, 4, 3837);
			...
			add_location(div1, file, 139, 8, 4098);
			attr_dev(div2, "class", "flex justify-center mb-16 bg-blue-700 border-2 border-gray-300 shadow-lg rounded-t-md");
			add_location(div2, file, 138, 4, 3989);
			attr_dev(h10, "class", "text-blue-800  mb-8 ");
			add_location(h10, file, 145, 8, 4327);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 147, 8, 4395);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 144, 4, 4299);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 155, 8, 4667);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 158, 12, 4846);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 161, 16, 5098);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 162, 16, 5150);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 163, 16, 5200);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 164, 16, 5275);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 160, 16, 5033);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 159, 12, 4977);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 169, 16, 5438);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 170, 16, 5502);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 171, 16, 5569);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 172, 16, 5653);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 173, 16, 5728);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 174, 16, 5818);
			add_location(tr1, file, 168, 16, 5416);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 177, 16, 5948);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 178, 16, 6012);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 179, 16, 6093);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 180, 16, 6179);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 181, 16, 6251);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 182, 16, 6338);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 176, 16, 5917);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 185, 16, 6456);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 186, 16, 6517);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 187, 16, 6585);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 188, 16, 6675);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 189, 16, 6751);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 190, 16, 6842);
			add_location(tr3, file, 184, 16, 6434);
			add_location(tbody0, file, 167, 12, 5391);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 157, 12, 4776);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 156, 8, 4726);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 201, 12, 7130);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 204, 16, 7373);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 205, 16, 7422);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 206, 16, 7479);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 207, 16, 7534);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 208, 16, 7591);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 203, 16, 7308);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 202, 12, 7252);
			add_location(tbody1, file, 213, 12, 7710);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 200, 12, 7060);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 199, 8, 7010);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 230, 12, 8380);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 229, 8, 8348);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 154, 4, 4629);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 143, 0, 4276);
			attr_dev(div10, "class", "mb-20 bg-white");
			add_location(div10, file, 132, 0, 3803);
		},
		m: function mount(target, anchor) {
