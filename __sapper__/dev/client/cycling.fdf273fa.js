import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.8fca32ff.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.41e69d62.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 16, 7402);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 16, 7473);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 16, 7535);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 16, 7609);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 16, 7724);
			add_location(tr, file, 210, 16, 7380);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td6, file, 171, 16, 5594);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 172, 16, 5658);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 173, 16, 5739);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 174, 16, 5825);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 175, 16, 5897);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 176, 16, 5984);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 170, 16, 5563);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 179, 16, 6102);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 180, 16, 6163);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 181, 16, 6231);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 182, 16, 6321);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 183, 16, 6397);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 184, 16, 6488);
			add_location(tr3, file, 178, 16, 6080);
			...
			add_location(caption1, file, 195, 12, 6776);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 198, 16, 6945);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 16, 6994);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 16, 7051);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 16, 7106);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 16, 7163);
			add_location(tr4, file, 197, 16, 6923);
			add_location(thead1, file, 196, 12, 6898);
			add_location(tbody1, file, 207, 12, 7282);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 194, 12, 6706);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 193, 8, 6656);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 227, 12, 7958);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 226, 8, 7926);
