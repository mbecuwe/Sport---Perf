...
import Running_charts from './running-charts.5fa51d0c.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 217, 12, 7621);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 218, 12, 7688);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 219, 12, 7746);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 220, 12, 7816);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 221, 12, 7927);
			add_location(tr, file, 216, 12, 7603);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(caption1, file, 201, 8, 6981);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 204, 12, 7212);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 205, 12, 7257);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 206, 12, 7310);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 207, 12, 7361);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 208, 12, 7414);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 203, 12, 7151);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 202, 8, 7099);
			add_location(tbody1, file, 213, 8, 7517);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 200, 8, 6915);
			attr_dev(div7, "class", "m-12 container mx-auto");
			add_location(div7, file, 199, 4, 6869);
			add_location(h3, file, 232, 8, 8133);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 231, 4, 8099);
