import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.6bdd5b33.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.cc7725bf.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 115, 4, 3233);
			attr_dev(div1, "class", "flex-initial w-2/3 p-2");
			add_location(div1, file, 114, 2, 3192);
			if (img.src !== (img_src_value = "cycling.jpg")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "alt", "cycling");
			add_location(img, file, 121, 4, 3419);
			attr_dev(div2, "class", " text-right p-2");
			add_location(div2, file, 120, 4, 3385);
			attr_dev(div3, "class", "flex-initial w-1/3 p-2");
			add_location(div3, file, 119, 2, 3344);
			attr_dev(div4, "class", "flex h-48");
			add_location(div4, file, 113, 0, 3166);
			add_location(li0, file, 130, 4, 3554);
			add_location(li1, file, 131, 8, 3574);
			add_location(lu, file, 129, 4, 3545);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 127, 0, 3486);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 141, 8, 3702);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 142, 8, 3745);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 143, 8, 3786);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 144, 8, 3852);
			add_location(tr0, file, 140, 8, 3689);
			add_location(thead0, file, 139, 4, 3673);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 149, 8, 3970);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 150, 8, 4025);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 151, 8, 4083);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 152, 8, 4146);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 153, 8, 4212);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 154, 8, 4276);
			add_location(tr1, file, 148, 8, 3957);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 157, 8, 4390);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 158, 8, 4445);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 159, 8, 4500);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 160, 8, 4560);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 161, 8, 4623);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 162, 8, 4684);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 156, 8, 4357);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 165, 8, 4775);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 166, 8, 4831);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 167, 8, 4890);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 168, 8, 4954);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 169, 8, 5021);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 170, 8, 5086);
			add_location(tr3, file, 164, 8, 4762);
			add_location(tbody0, file, 147, 4, 3941);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 138, 4, 3629);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 137, 0, 3606);
			add_location(h3, file, 180, 1, 5224);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 179, 0, 5198);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 192, 8, 5436);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 193, 8, 5479);
			attr_dev(th6, "colspan", "2");
			attr_dev(th6, "class", "px-4 py-2 ");
			add_location(th6, file, 194, 8, 5520);
			attr_dev(th7, "colspan", "2");
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 195, 8, 5586);
			add_location(tr4, file, 191, 8, 5423);
			add_location(thead1, file, 190, 4, 5407);
			attr_dev(td18, "class", "border px-4 py-2");
			add_location(td18, file, 200, 8, 5704);
			attr_dev(td19, "class", "border px-4 py-2");
			add_location(td19, file, 201, 8, 5759);
			attr_dev(td20, "class", "border px-4 py-2");
			add_location(td20, file, 202, 8, 5817);
			attr_dev(td21, "class", "border px-4 py-2");
			add_location(td21, file, 203, 8, 5880);
			attr_dev(td22, "class", "border px-4 py-2");
			add_location(td22, file, 204, 8, 5946);
			attr_dev(td23, "class", "border px-4 py-2");
			add_location(td23, file, 205, 8, 6010);
			add_location(tr5, file, 199, 8, 5691);
			attr_dev(td24, "class", "border px-4 py-2");
			add_location(td24, file, 208, 8, 6124);
			attr_dev(td25, "class", "border px-4 py-2");
			add_location(td25, file, 209, 8, 6179);
			attr_dev(td26, "class", "border px-4 py-2");
			add_location(td26, file, 210, 8, 6234);
			attr_dev(td27, "class", "border px-4 py-2");
			add_location(td27, file, 211, 8, 6294);
			attr_dev(td28, "class", "border px-4 py-2");
			add_location(td28, file, 212, 8, 6357);
			attr_dev(td29, "class", "border px-4 py-2");
			add_location(td29, file, 213, 8, 6418);
			attr_dev(tr6, "class", "bg-gray-100");
			add_location(tr6, file, 207, 8, 6091);
			attr_dev(td30, "class", "border px-4 py-2");
			add_location(td30, file, 216, 8, 6509);
			attr_dev(td31, "class", "border px-4 py-2");
			add_location(td31, file, 217, 8, 6565);
			attr_dev(td32, "class", "border px-4 py-2");
			add_location(td32, file, 218, 8, 6624);
			attr_dev(td33, "class", "border px-4 py-2");
			add_location(td33, file, 219, 8, 6688);
			attr_dev(td34, "class", "border px-4 py-2");
			add_location(td34, file, 220, 8, 6755);
			attr_dev(td35, "class", "border px-4 py-2");
			add_location(td35, file, 221, 8, 6820);
			add_location(tr7, file, 215, 8, 6496);
			add_location(tbody1, file, 198, 4, 5675);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 189, 4, 5363);
			attr_dev(div8, "class", "p-10");
			add_location(div8, file, 188, 0, 5340);
			add_location(div9, file, 184, 0, 5300);
		},
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
