import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.709cd7dc.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.38e21bfd.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file, 134, 4, 3630);
			add_location(li1, file, 135, 8, 3650);
			add_location(lu, file, 133, 4, 3621);
			attr_dev(div5, "class", "px-10");
			add_location(div5, file, 131, 0, 3562);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 145, 8, 3778);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 146, 8, 3821);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 147, 8, 3862);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 148, 8, 3928);
			add_location(tr0, file, 144, 8, 3765);
			add_location(thead0, file, 143, 4, 3749);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 153, 8, 4046);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 154, 8, 4101);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 155, 8, 4159);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 156, 8, 4222);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 157, 8, 4288);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 158, 8, 4352);
			add_location(tr1, file, 152, 8, 4033);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 161, 8, 4466);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 162, 8, 4521);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 163, 8, 4576);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 164, 8, 4636);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 165, 8, 4699);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 166, 8, 4760);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 160, 8, 4433);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 169, 8, 4851);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 170, 8, 4907);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 171, 8, 4966);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 172, 8, 5030);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 173, 8, 5097);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 174, 8, 5162);
			add_location(tr3, file, 168, 8, 4838);
			add_location(tbody0, file, 151, 4, 4017);
			attr_dev(table0, "class", "table-auto text-center ");
			add_location(table0, file, 142, 4, 3705);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 141, 0, 3682);
			add_location(h3, file, 184, 1, 5300);
			attr_dev(div7, "class", "px-10 py-5");
			add_location(div7, file, 183, 0, 5274);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 196, 8, 5512);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 197, 8, 5555);
			attr_dev(th6, "colspan", "2");
			attr_dev(th6, "class", "px-4 py-2 ");
			add_location(th6, file, 198, 8, 5596);
			attr_dev(th7, "colspan", "2");
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 199, 8, 5662);
			add_location(tr4, file, 195, 8, 5499);
			add_location(thead1, file, 194, 4, 5483);
			attr_dev(td18, "class", "border px-4 py-2");
			add_location(td18, file, 204, 8, 5780);
			attr_dev(td19, "class", "border px-4 py-2");
			add_location(td19, file, 205, 8, 5835);
			attr_dev(td20, "class", "border px-4 py-2");
			add_location(td20, file, 206, 8, 5893);
			attr_dev(td21, "class", "border px-4 py-2");
			add_location(td21, file, 207, 8, 5956);
			attr_dev(td22, "class", "border px-4 py-2");
			add_location(td22, file, 208, 8, 6022);
			attr_dev(td23, "class", "border px-4 py-2");
			add_location(td23, file, 209, 8, 6086);
			add_location(tr5, file, 203, 8, 5767);
			attr_dev(td24, "class", "border px-4 py-2");
			add_location(td24, file, 212, 8, 6200);
			attr_dev(td25, "class", "border px-4 py-2");
			add_location(td25, file, 213, 8, 6255);
			attr_dev(td26, "class", "border px-4 py-2");
			add_location(td26, file, 214, 8, 6310);
			attr_dev(td27, "class", "border px-4 py-2");
			add_location(td27, file, 215, 8, 6370);
			attr_dev(td28, "class", "border px-4 py-2");
			add_location(td28, file, 216, 8, 6433);
			attr_dev(td29, "class", "border px-4 py-2");
			add_location(td29, file, 217, 8, 6494);
			attr_dev(tr6, "class", "bg-gray-100");
			add_location(tr6, file, 211, 8, 6167);
			attr_dev(td30, "class", "border px-4 py-2");
			add_location(td30, file, 220, 8, 6585);
			attr_dev(td31, "class", "border px-4 py-2");
			add_location(td31, file, 221, 8, 6641);
			attr_dev(td32, "class", "border px-4 py-2");
			add_location(td32, file, 222, 8, 6700);
			attr_dev(td33, "class", "border px-4 py-2");
			add_location(td33, file, 223, 8, 6764);
			attr_dev(td34, "class", "border px-4 py-2");
			add_location(td34, file, 224, 8, 6831);
			attr_dev(td35, "class", "border px-4 py-2");
			add_location(td35, file, 225, 8, 6896);
			add_location(tr7, file, 219, 8, 6572);
			add_location(tbody1, file, 202, 4, 5751);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 193, 4, 5439);
			attr_dev(div8, "class", "p-10");
			add_location(div8, file, 192, 0, 5416);
			add_location(div9, file, 188, 0, 5376);
		},
