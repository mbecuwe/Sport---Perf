...
import Cycling_charts from './cycling-charts.1270634d.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 206, 12, 5972);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 207, 12, 6038);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 208, 12, 6095);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 209, 12, 6164);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 210, 12, 6257);
			add_location(tr, file, 205, 12, 5955);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th4, file, 193, 12, 5576);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 194, 12, 5620);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 195, 12, 5672);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 196, 12, 5722);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 197, 12, 5774);
			add_location(tr4, file, 192, 12, 5559);
			add_location(thead1, file, 191, 8, 5539);
			add_location(tbody1, file, 202, 8, 5872);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 190, 8, 5491);
			attr_dev(div7, "class", "py-5");
			add_location(div7, file, 189, 4, 5464);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 186, 0, 5402);
			add_location(h3, file, 224, 1, 6450);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 223, 0, 6424);
		},
		m: function mount(target, anchor) {
