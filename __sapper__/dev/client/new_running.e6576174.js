...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input3, file, 89, 8, 3675);
			add_location(br3, file, 90, 12, 3892);
			...
			add_location(button, file, 92, 8, 3908);
			add_location(form, file, 63, 8, 2237);
			add_location(br4, file, 95, 12, 4140);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4158);
			attr_dev(div3, "class", " p-2");
			add_location(div3, file, 62, 4, 2210);
			attr_dev(div4, "class", "flex-initial w-2/3 p-2");
			add_location(div4, file, 58, 2, 2063);
