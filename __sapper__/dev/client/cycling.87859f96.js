import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.5c993385.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.922d7ce0.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 16, 7465);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 16, 7536);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 16, 7598);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 16, 7672);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 16, 7787);
			add_location(tr, file, 210, 16, 7443);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th0, file, 155, 16, 4764);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 156, 16, 4816);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 157, 16, 4866);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 158, 16, 4941);
			attr_dev(tr0, "class", "bg-blue-100");
			add_location(tr0, file, 154, 16, 4722);
			add_location(thead0, file, 153, 12, 4697);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 163, 16, 5104);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 164, 16, 5168);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 165, 16, 5235);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 166, 16, 5319);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 167, 16, 5394);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 168, 16, 5484);
			add_location(tr1, file, 162, 16, 5082);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 171, 16, 5614);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 172, 16, 5678);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 173, 16, 5759);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 174, 16, 5845);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 175, 16, 5917);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 176, 16, 6004);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 170, 16, 5583);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 179, 16, 6122);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 180, 16, 6183);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 181, 16, 6251);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 182, 16, 6341);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 183, 16, 6417);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 184, 16, 6508);
			add_location(tr3, file, 178, 16, 6100);
			add_location(tbody0, file, 161, 12, 5057);
			...
			add_location(caption1, file, 195, 12, 6796);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 198, 16, 7008);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 16, 7057);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 16, 7114);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 16, 7169);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 16, 7226);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-200");
			add_location(tr4, file, 197, 16, 6943);
			add_location(thead1, file, 196, 12, 6918);
			add_location(tbody1, file, 207, 12, 7345);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 194, 12, 6726);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 193, 8, 6676);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 227, 12, 8021);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 226, 8, 7989);
