...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input2, file, 89, 8, 3606);
			add_location(br2, file, 90, 12, 3817);
			...
			add_location(label3, file, 92, 8, 3833);
			...
			add_location(input3, file, 94, 8, 3968);
			add_location(br3, file, 95, 12, 4195);
			...
			add_location(button, file, 98, 8, 4281);
			attr_dev(div5, "class", "flex");
			add_location(div5, file, 97, 8, 4254);
			attr_dev(div6, "class", "flex justify-end my-8");
			add_location(div6, file, 96, 8, 4210);
			add_location(form, file, 68, 8, 2523);
			add_location(br4, file, 103, 12, 4551);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 107, 8, 4569);
			attr_dev(div8, "class", " p-2");
			add_location(div8, file, 67, 4, 2496);
			attr_dev(div9, "class", "flex-initial w-2/3 p-2");
			add_location(div9, file, 63, 2, 2348);
			attr_dev(div10, "class", "flex justify-center ");
