import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.cd4493ca.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input0, file, 133, 21, 5092);
			add_location(div2, file, 132, 16, 5064);
			...
			add_location(label1, file, 141, 12, 5351);
			...
			add_location(div4, file, 154, 16, 6046);
			...
			add_location(input9, file, 196, 8, 8575);
			add_location(br7, file, 197, 12, 8792);
			...
			add_location(button, file, 199, 8, 8808);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 202, 12, 9040);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 206, 8, 9058);
