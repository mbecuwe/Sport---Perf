import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_each_argument, a as validate_slots, e as element, t as text, c as claim_element, b as children, f as claim_text, g as detach_dev, h as attr_dev, j as add_location, k as insert_dev, l as append_dev, n as noop, m as space, o as claim_space, G as create_component, H as claim_component, I as toggle_class, J as mount_component, D as transition_in, E as transition_out, p as destroy_each, K as destroy_component } from './client.42012452.js';
import './Chart.ff97f108.js';
import Running_charts from './running-charts.4b1060fd.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 164, 12, 4765);
		},
...
// (230:16) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 231, 16, 8451);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 232, 16, 8521);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 233, 16, 8582);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 234, 16, 8655);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 235, 16, 8769);
			add_location(tr, file, 230, 16, 8430);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(230:16) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 150, 8, 4120);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 149, 4, 4085);
			...
			add_location(td3, file, 188, 16, 5861);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 189, 16, 6012);
			...
			add_location(td5, file, 190, 16, 6101);
			add_location(tr1, file, 184, 16, 5628);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 193, 16, 6307);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 194, 16, 6370);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 195, 16, 6450);
			...
			add_location(td9, file, 196, 16, 6535);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 197, 16, 6677);
			...
			add_location(td11, file, 198, 16, 6763);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 192, 16, 6277);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 201, 16, 6951);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 202, 16, 7011);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 203, 16, 7078);
			...
			add_location(td15, file, 204, 16, 7167);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 205, 16, 7321);
			...
			add_location(td17, file, 206, 16, 7411);
			add_location(tr3, file, 200, 16, 6930);
			add_location(tbody0, file, 183, 12, 5604);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 173, 12, 4999);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 172, 8, 4950);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 215, 12, 7767);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 218, 16, 8007);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 219, 16, 8055);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 220, 16, 8111);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 221, 16, 8165);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 222, 16, 8221);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 217, 16, 7943);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 216, 12, 7888);
			add_location(tbody1, file, 227, 12, 8335);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 214, 12, 7698);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 213, 8, 7649);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 244, 12, 8988);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 243, 8, 8957);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 170, 4, 4855);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 158, 4, 4512);
			attr_dev(div10, "class", "mb-20");
			add_location(div10, file, 147, 0, 4060);
		},
		m: function mount(target, anchor) {
...
export { preload };
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
