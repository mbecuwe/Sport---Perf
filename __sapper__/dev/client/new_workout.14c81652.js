...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			div7 = claim_element(form_nodes, "DIV", { id: true });
		...
		h: function hydrate() {
			...
			add_location(br, file, 135, 12, 5345);
			...
			add_location(div7, file, 155, 8, 6223);
