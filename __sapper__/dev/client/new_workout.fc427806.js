import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.724a1403.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(input1, "class", "appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded p-2 mb-3");
			...
			attr_dev(input2, "class", "appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded p-2 mb-3");
			add_location(input2, file, 146, 20, 5886);
			attr_dev(div3, "class", "flex w-1/2");
			add_location(div3, file, 145, 16, 5841);
			attr_dev(div4, "class", "flex");
			add_location(div4, file, 136, 12, 5364);
			add_location(br1, file, 153, 11, 6133);
			attr_dev(label3, "for", "meters");
			attr_dev(label3, "class", "block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2");
			add_location(label3, file, 154, 8, 6148);
			...
			add_location(input8, file, 182, 8, 8088);
			add_location(br7, file, 183, 12, 8305);
			...
			add_location(button, file, 185, 8, 8321);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 188, 12, 8553);
			attr_dev(div5, "id", "add_to_me");
			add_location(div5, file, 192, 8, 8571);
