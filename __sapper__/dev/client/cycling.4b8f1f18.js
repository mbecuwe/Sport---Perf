import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.e2ff4efd.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.8060e42d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th0, file, 155, 16, 4828);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 156, 16, 4880);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 157, 16, 4930);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 158, 16, 5005);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 154, 16, 4763);
			attr_dev(thead0, "class", "border-gray-300");
			add_location(thead0, file, 153, 12, 4714);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 163, 16, 5168);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 164, 16, 5232);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 165, 16, 5299);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 166, 16, 5383);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 167, 16, 5458);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 168, 16, 5548);
			add_location(tr1, file, 162, 16, 5146);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 171, 16, 5678);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 172, 16, 5742);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 173, 16, 5823);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 174, 16, 5909);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 175, 16, 5981);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 176, 16, 6068);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 170, 16, 5647);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 179, 16, 6186);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 180, 16, 6247);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 181, 16, 6315);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 182, 16, 6405);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 183, 16, 6481);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 184, 16, 6572);
			add_location(tr3, file, 178, 16, 6164);
			add_location(tbody0, file, 161, 12, 5121);
			...
			add_location(caption1, file, 195, 12, 6860);
