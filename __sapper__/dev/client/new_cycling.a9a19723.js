...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button0, file, 95, 8, 3998);
			...
			add_location(button1, file, 102, 8, 4251);
			add_location(form, file, 63, 8, 2242);
			add_location(br4, file, 107, 12, 4485);
			attr_dev(div4, "id", "add_to_me");
			add_location(div4, file, 111, 8, 4503);
