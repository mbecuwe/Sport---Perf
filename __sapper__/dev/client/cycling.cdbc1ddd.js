...
import Cycling_charts from './cycling-charts.f1850141.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 149, 12, 4377);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 217, 16, 7604);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 218, 16, 7674);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 219, 16, 7735);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 220, 16, 7808);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 221, 16, 7922);
			add_location(tr, file, 216, 16, 7583);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div1, file, 139, 8, 3967);
			attr_dev(div2, "class", "flex justify-center mb-16 bg-blue-700 border-2 border-gray-300 shadow-lg rounded-t-md");
			add_location(div2, file, 138, 4, 3859);
			attr_dev(h10, "class", "text-blue-800  mb-8 ");
			add_location(h10, file, 145, 8, 4173);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 147, 8, 4239);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 144, 4, 4146);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 155, 8, 4503);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 158, 12, 4679);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 161, 16, 4928);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 162, 16, 4979);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 163, 16, 5028);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 164, 16, 5102);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 160, 16, 4864);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 159, 12, 4809);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 169, 16, 5260);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 170, 16, 5323);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 171, 16, 5389);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 172, 16, 5472);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 173, 16, 5546);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 174, 16, 5635);
			add_location(tr1, file, 168, 16, 5239);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 177, 16, 5762);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 178, 16, 5825);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 179, 16, 5905);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 180, 16, 5990);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 181, 16, 6061);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 182, 16, 6147);
			attr_dev(tr2, "class", "");
			add_location(tr2, file, 176, 16, 5732);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 185, 16, 6262);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 186, 16, 6322);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 187, 16, 6389);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 188, 16, 6478);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 189, 16, 6553);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 190, 16, 6643);
			add_location(tr3, file, 184, 16, 6241);
			add_location(tbody0, file, 167, 12, 5215);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 157, 12, 4610);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 156, 8, 4561);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 201, 12, 6920);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 204, 16, 7160);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 205, 16, 7208);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 206, 16, 7264);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 207, 16, 7318);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 208, 16, 7374);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 203, 16, 7096);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 202, 12, 7041);
			add_location(tbody1, file, 213, 12, 7488);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 200, 12, 6851);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 199, 8, 6802);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 230, 12, 8141);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 229, 8, 8110);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 154, 4, 4466);
			attr_dev(div9, "class", "p-8");
			add_location(div9, file, 137, 4, 3837);
			attr_dev(div10, "class", "mb-20");
			add_location(div10, file, 132, 0, 3671);
		},
		m: function mount(target, anchor) {
