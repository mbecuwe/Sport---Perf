import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.0ae5997d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input5, file, 174, 20, 7242);
			attr_dev(div10, "class", "flex w-1/2 m-2");
			add_location(div10, file, 173, 16, 7193);
			...
			add_location(input6, file, 177, 20, 7501);
			attr_dev(div11, "class", "flex w-1/2 m-2");
			add_location(div11, file, 176, 16, 7452);
			attr_dev(div12, "class", "flex");
			add_location(div12, file, 169, 24, 7001);
			add_location(br3, file, 181, 12, 7725);
			...
			add_location(button, file, 187, 8, 7812);
			attr_dev(div13, "class", "flex");
			add_location(div13, file, 186, 8, 7785);
			attr_dev(div14, "class", "flex justify-center");
			add_location(div14, file, 185, 8, 7743);
			add_location(form, file, 120, 8, 4644);
			add_location(br4, file, 195, 12, 8093);
			attr_dev(div15, "id", "add_to_me");
			add_location(div15, file, 199, 8, 8111);
