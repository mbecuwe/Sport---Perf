import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, F as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, G as destroy_each, B as destroy_component } from './client.11cf66a9.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.c429eea3.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 212, 8, 5988);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 213, 8, 6050);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 214, 8, 6103);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 215, 8, 6168);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 216, 8, 6257);
			add_location(tr, file, 211, 8, 5975);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th4, file, 199, 8, 5640);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 200, 8, 5680);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 201, 8, 5728);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 202, 8, 5774);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 203, 8, 5822);
			add_location(tr4, file, 198, 8, 5627);
			add_location(thead1, file, 197, 4, 5611);
			add_location(tbody1, file, 208, 4, 5904);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 196, 4, 5567);
