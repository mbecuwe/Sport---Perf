...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input3, file, 89, 8, 3668);
			add_location(br3, file, 90, 12, 3885);
			...
			add_location(button, file, 92, 8, 3901);
			add_location(form, file, 63, 8, 2230);
			add_location(br4, file, 95, 12, 4133);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4151);
			attr_dev(div3, "class", " p-2");
			add_location(div3, file, 62, 4, 2203);
			attr_dev(div4, "class", "flex-initial w-2/3 p-2");
			add_location(div4, file, 58, 2, 2056);
			attr_dev(div5, "class", "flex ");
			add_location(div5, file, 50, 0, 1841);
		},
