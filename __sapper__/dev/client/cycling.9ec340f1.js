import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, F as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, G as destroy_each, B as destroy_component } from './client.d8f12589.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.e72d6373.js';
...
// (211:8) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 212, 8, 5994);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 213, 8, 6056);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 214, 8, 6109);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 215, 8, 6174);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 216, 8, 6263);
			add_location(tr, file, 211, 8, 5981);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(211:8) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th4, file, 199, 8, 5646);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 200, 8, 5686);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 201, 8, 5734);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 202, 8, 5780);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 203, 8, 5828);
			add_location(tr4, file, 198, 8, 5633);
			add_location(thead1, file, 197, 4, 5617);
			add_location(tbody1, file, 208, 4, 5910);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 196, 4, 5573);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 195, 0, 5544);
