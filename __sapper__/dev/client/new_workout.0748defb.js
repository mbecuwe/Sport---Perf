...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br1, file, 165, 12, 6535);
			attr_dev(div8, "id", "add_to_me");
			add_location(div8, file, 169, 8, 6553);
