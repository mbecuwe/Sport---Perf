import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.de6c16bd.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label2, file, 142, 20, 5584);
			attr_dev(div4, "class", "flex w-1/2 m-2");
			add_location(div4, file, 141, 16, 5535);
			...
			add_location(input1, file, 146, 20, 5800);
			attr_dev(div5, "class", "flex w-1/2 m-2");
			add_location(div5, file, 145, 16, 5751);
			...
			add_location(input2, file, 149, 20, 6059);
			attr_dev(div6, "class", "flex w-1/2 m-2");
			add_location(div6, file, 148, 16, 6010);
			attr_dev(div7, "class", "flex");
			add_location(div7, file, 140, 12, 5500);
			add_location(br1, file, 153, 12, 6283);
			attr_dev(label3, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xs font-bold m-3");
			add_location(label3, file, 160, 20, 6390);
			attr_dev(div8, "class", "flex w-1/2 m-2");
			add_location(div8, file, 159, 16, 6341);
			...
			add_location(input3, file, 164, 20, 6612);
			attr_dev(div9, "class", "flex w-1/2 m-2");
			add_location(div9, file, 163, 16, 6563);
			...
			add_location(input4, file, 167, 20, 6884);
			attr_dev(div10, "class", "flex w-1/2 m-2");
			add_location(div10, file, 166, 16, 6835);
			attr_dev(div11, "class", "flex");
			add_location(div11, file, 158, 12, 6306);
			add_location(br2, file, 171, 12, 7121);
			attr_dev(label4, "class", "block uppercase p-2 tracking-wide text-grey-darker text-xs font-bold m-3");
			add_location(label4, file, 175, 16, 7177);
			...
			add_location(input5, file, 179, 20, 7383);
			attr_dev(div12, "class", "flex w-1/2 m-2");
			add_location(div12, file, 178, 16, 7334);
			...
			add_location(input6, file, 182, 20, 7649);
			attr_dev(div13, "class", "flex w-1/2 m-2");
			add_location(div13, file, 181, 16, 7600);
			attr_dev(div14, "class", "flex");
			add_location(div14, file, 174, 12, 7142);
			add_location(br3, file, 186, 12, 7880);
			...
			add_location(button, file, 191, 8, 7966);
			attr_dev(div15, "class", "flex");
			add_location(div15, file, 190, 8, 7939);
			attr_dev(div16, "class", "flex justify-center");
			add_location(div16, file, 189, 8, 7897);
			add_location(form, file, 120, 8, 4644);
			add_location(br4, file, 199, 12, 8247);
			attr_dev(div17, "id", "add_to_me");
			add_location(div17, file, 203, 8, 8265);
