...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			if (img.src !== (img_src_value = "workout_draw")) attr_dev(img, "src", img_src_value);
			...
			add_location(input3, file, 89, 8, 3665);
			add_location(br3, file, 90, 12, 3882);
			...
			add_location(button, file, 92, 8, 3898);
			add_location(form, file, 63, 8, 2227);
			add_location(br4, file, 95, 12, 4130);
			attr_dev(div2, "id", "add_to_me");
			add_location(div2, file, 99, 8, 4148);
			attr_dev(div3, "class", " p-2");
			add_location(div3, file, 62, 4, 2200);
			attr_dev(div4, "class", "flex-initial w-2/3 p-2");
			add_location(div4, file, 58, 2, 2053);
