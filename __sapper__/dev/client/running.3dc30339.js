import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, M as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, N as destroy_each, B as destroy_component } from './client.4af9ffec.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Running_charts from './running-charts.50736c10.js';
...
// (148:12) {#each get_last_nb_sessions(3, list_date) as date}
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 148, 12, 4223);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(148:12) {#each get_last_nb_sessions(3, list_date) as date}",
		ctx
	});
...
// (214:16) {#each distance_3_session as distance, i}
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 215, 16, 7465);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 216, 16, 7535);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 217, 16, 7596);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 218, 16, 7669);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 219, 16, 7783);
			add_location(tr, file, 214, 16, 7444);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(214:16) {#each distance_3_session as distance, i}",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 134, 8, 3599);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 133, 4, 3564);
			...
			add_location(div1, file, 138, 8, 3813);
			attr_dev(div2, "class", "flex justify-center mb-16 bg-blue-700 border-2 border-gray-300 shadow-lg rounded-t-md");
			add_location(div2, file, 137, 4, 3705);
			attr_dev(h10, "class", "text-blue-800  mb-8 ");
			add_location(h10, file, 144, 8, 4019);
			attr_dev(div3, "class", "italic grid grid-cols-3 divide-x divide-gray-400");
			add_location(div3, file, 146, 8, 4085);
			attr_dev(div4, "class", "pb-8");
			add_location(div4, file, 143, 4, 3992);
			attr_dev(h11, "class", "text-blue-800");
			add_location(h11, file, 155, 8, 4350);
			attr_dev(caption0, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption0, file, 158, 12, 4526);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 161, 16, 4775);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 162, 16, 4826);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 163, 16, 4875);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 164, 16, 4949);
			attr_dev(tr0, "class", "bg-blue-100 border border-gray-300");
			add_location(tr0, file, 160, 16, 4711);
			attr_dev(thead0, "class", "border-gray-300 italic");
			add_location(thead0, file, 159, 12, 4656);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 169, 16, 5107);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 170, 16, 5170);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 171, 16, 5236);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 172, 16, 5324);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 173, 16, 5398);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 174, 16, 5487);
			add_location(tr1, file, 168, 16, 5086);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 177, 16, 5625);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 178, 16, 5688);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 179, 16, 5768);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 180, 16, 5853);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 181, 16, 5924);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 182, 16, 6010);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 176, 16, 5584);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 185, 16, 6125);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 186, 16, 6185);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 187, 16, 6252);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 188, 16, 6341);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 189, 16, 6416);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 190, 16, 6506);
			add_location(tr3, file, 184, 16, 6104);
			add_location(tbody0, file, 167, 12, 5062);
			attr_dev(table0, "class", "table-auto text-center container mx-auto");
			add_location(table0, file, 157, 12, 4457);
			attr_dev(div5, "class", "m-12 container mx-auto");
			add_location(div5, file, 156, 8, 4408);
			attr_dev(caption1, "class", "font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption1, file, 199, 12, 6781);
			attr_dev(th4, "class", "px-4 py-2");
			add_location(th4, file, 202, 16, 7021);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 203, 16, 7069);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 204, 16, 7125);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 205, 16, 7179);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 206, 16, 7235);
			attr_dev(tr4, "class", "bg-blue-100 border border-gray-300");
			add_location(tr4, file, 201, 16, 6957);
			attr_dev(thead1, "class", "italic border-gray-300");
			add_location(thead1, file, 200, 12, 6902);
			add_location(tbody1, file, 211, 12, 7349);
			attr_dev(table1, "class", "table-auto text-center container mx-auto");
			add_location(table1, file, 198, 12, 6712);
			attr_dev(div6, "class", "m-12 container mx-auto");
			add_location(div6, file, 197, 8, 6663);
			attr_dev(h12, "class", "text-blue-800 mb-8 mt-16");
			add_location(h12, file, 228, 12, 8002);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 227, 8, 7971);
			attr_dev(div8, "class", "divide-y mt-16");
			add_location(div8, file, 154, 4, 4313);
			attr_dev(div9, "class", "mb-20");
			add_location(div9, file, 131, 0, 3539);
		},
		m: function mount(target, anchor) {
