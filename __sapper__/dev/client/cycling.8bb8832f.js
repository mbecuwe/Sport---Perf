import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, a as space, w as create_component, f as claim_element, g as children, h as claim_text, b as detach_dev, c as claim_space, x as claim_component, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, y as mount_component, n as noop, z as transition_in, A as transition_out, B as destroy_component } from './client.7ff863b6.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.7875fc4d.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file, 126, 4, 3430);
			add_location(li1, file, 127, 8, 3450);
			add_location(lu, file, 125, 4, 3421);
			attr_dev(div5, "div", "p-10");
			add_location(div5, file, 123, 0, 3365);
			attr_dev(th0, "class", "px-4 py-2");
			add_location(th0, file, 137, 8, 3578);
			attr_dev(th1, "class", "px-4 py-2");
			add_location(th1, file, 138, 8, 3621);
			attr_dev(th2, "colspan", "2");
			attr_dev(th2, "class", "px-4 py-2 ");
			add_location(th2, file, 139, 8, 3662);
			attr_dev(th3, "colspan", "2");
			attr_dev(th3, "class", "px-4 py-2");
			add_location(th3, file, 140, 8, 3728);
			add_location(tr0, file, 136, 8, 3565);
			add_location(thead, file, 135, 4, 3549);
			attr_dev(td0, "class", "border px-4 py-2");
			add_location(td0, file, 145, 8, 3846);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 146, 8, 3901);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 147, 8, 3959);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 148, 8, 4022);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 149, 8, 4088);
			attr_dev(td5, "class", "border px-4 py-2");
			add_location(td5, file, 150, 8, 4152);
			add_location(tr1, file, 144, 8, 3833);
			attr_dev(td6, "class", "border px-4 py-2");
			add_location(td6, file, 153, 8, 4266);
			attr_dev(td7, "class", "border px-4 py-2");
			add_location(td7, file, 154, 8, 4321);
			attr_dev(td8, "class", "border px-4 py-2");
			add_location(td8, file, 155, 8, 4376);
			attr_dev(td9, "class", "border px-4 py-2");
			add_location(td9, file, 156, 8, 4436);
			attr_dev(td10, "class", "border px-4 py-2");
			add_location(td10, file, 157, 8, 4499);
			attr_dev(td11, "class", "border px-4 py-2");
			add_location(td11, file, 158, 8, 4560);
			attr_dev(tr2, "class", "bg-gray-100");
			add_location(tr2, file, 152, 8, 4233);
			attr_dev(td12, "class", "border px-4 py-2");
			add_location(td12, file, 161, 8, 4651);
			attr_dev(td13, "class", "border px-4 py-2");
			add_location(td13, file, 162, 8, 4707);
			attr_dev(td14, "class", "border px-4 py-2");
			add_location(td14, file, 163, 8, 4766);
			attr_dev(td15, "class", "border px-4 py-2");
			add_location(td15, file, 164, 8, 4830);
			attr_dev(td16, "class", "border px-4 py-2");
			add_location(td16, file, 165, 8, 4897);
			attr_dev(td17, "class", "border px-4 py-2");
			add_location(td17, file, 166, 8, 4962);
			add_location(tr3, file, 160, 8, 4638);
			add_location(tbody, file, 143, 4, 3817);
			attr_dev(table, "class", "table-auto text-center ");
			add_location(table, file, 134, 4, 3505);
			attr_dev(div6, "class", "p-10");
			add_location(div6, file, 133, 0, 3482);
			attr_dev(h3, "class", "px-10 py-5");
			add_location(h3, file, 176, 1, 5082);
			add_location(div7, file, 175, 0, 5074);
		},
