import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, J as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, K as destroy_each, B as destroy_component } from './client.b53a9749.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.97e39373.js';
import Cycling_charts from './cycling-charts.fc88f12b.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 16, 7489);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 16, 7560);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 16, 7622);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 16, 7696);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 16, 7811);
			add_location(tr, file, 210, 16, 7467);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h12, file, 227, 12, 8045);
			attr_dev(div7, "class", "mt-8");
			add_location(div7, file, 226, 8, 8013);
