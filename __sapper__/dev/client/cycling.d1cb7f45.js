...
import Cycling_charts from './cycling-charts.6f18a60e.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 213, 12, 6205);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 214, 12, 6271);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 215, 12, 6328);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 216, 12, 6397);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 217, 12, 6507);
			add_location(tr, file, 212, 12, 6188);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(tbody1, file, 209, 8, 6105);
			...
			add_location(h3, file, 231, 1, 6700);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 230, 0, 6674);
		},
		m: function mount(target, anchor) {
