import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.84505794.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input0, file, 133, 21, 5105);
			...
			add_location(label1, file, 141, 12, 5364);
			...
			add_location(input2, file, 155, 20, 6108);
			attr_dev(div4, "class", "flex w-1/2 m-3");
			add_location(div4, file, 154, 16, 6059);
			...
			add_location(input9, file, 196, 8, 8588);
			add_location(br7, file, 197, 12, 8805);
			...
			add_location(button, file, 199, 8, 8821);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 202, 12, 9053);
			attr_dev(div7, "id", "add_to_me");
			add_location(div7, file, 206, 8, 9071);
