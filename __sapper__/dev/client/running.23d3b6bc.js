...
import Running_charts from './running-charts.b08b513e.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 219, 16, 7521);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 220, 16, 7592);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 221, 16, 7654);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 222, 16, 7728);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 223, 16, 7843);
			add_location(tr, file, 218, 16, 7499);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t60 = claim_text(div8_nodes, "Get the data available in table\r\n\r\n        ");
		...
		h: function hydrate() {
			...
			add_location(caption, file, 157, 12, 4671);
			...
			add_location(th4, file, 206, 16, 7064);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 207, 16, 7113);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 208, 16, 7170);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 209, 16, 7225);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 210, 16, 7282);
			add_location(tr4, file, 205, 16, 7042);
			add_location(thead1, file, 204, 12, 7017);
			add_location(tbody1, file, 215, 12, 7401);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 203, 12, 6964);
			attr_dev(div7, "class", "py-5");
			add_location(div7, file, 202, 8, 6932);
			attr_dev(div8, "class", "px-10 py-5");
			add_location(div8, file, 199, 4, 6859);
			add_location(h3, file, 237, 8, 8089);
			attr_dev(div9, "class", "px-10 py-5");
			add_location(div9, file, 236, 4, 8055);
