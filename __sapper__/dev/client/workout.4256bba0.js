import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_each_argument, a as validate_slots, e as element, t as text, c as claim_element, f as children, j as claim_text, g as detach_dev, k as attr_dev, l as add_location, m as insert_dev, n as append_dev, o as noop, b as space, h as claim_space, G as create_component, H as claim_component, I as toggle_class, J as mount_component, D as transition_in, E as transition_out, p as destroy_each, K as destroy_component } from './client.23eaac9a.js';
import './moment.98d1f4f0.js';
import './Chart.d62ec9f6.js';
import Workoutpushups_radar from './workoutpushups-radar.2174bfe5.js';
import Workoutothers_radar from './workoutothers-radar.a3ae7603.js';
import Workoutabdo_radar from './workoutabdo-radar.0f0f9686.js';
import Workoutlegs_radar from './workoutlegs-radar.2d70b7ff.js';
...
function create_each_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 300, 12, 8713);
		},
...
function create_each_block_3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 341, 12, 10161);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 342, 12, 10222);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 343, 12, 10295);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 344, 12, 10368);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 345, 12, 10447);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 346, 12, 10526);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 347, 12, 10605);
			attr_dev(td7, "class", "border px-2 py-2");
			add_location(td7, file, 348, 12, 10684);
			attr_dev(td8, "class", "border px-2 py-2");
			add_location(td8, file, 349, 12, 10760);
			add_location(tr, file, 340, 12, 10144);
		},
		m: function mount(target, anchor) {
...
function create_each_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 403, 12, 12898);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 404, 12, 12959);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 405, 12, 13034);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 406, 12, 13109);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 407, 12, 13192);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 408, 12, 13275);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 409, 12, 13358);
			attr_dev(td7, "class", "border px-2 py-2");
			add_location(td7, file, 410, 12, 13441);
			attr_dev(td8, "class", "border px-2 py-2");
			add_location(td8, file, 411, 12, 13522);
			attr_dev(td9, "class", "border px-2 py-2");
			add_location(td9, file, 412, 12, 13603);
			attr_dev(td10, "class", "border px-2 py-2");
			add_location(td10, file, 413, 12, 13685);
			add_location(tr, file, 402, 12, 12881);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 462, 12, 15541);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 463, 12, 15602);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 464, 12, 15678);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 465, 12, 15754);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 466, 12, 15838);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 467, 12, 15922);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 468, 12, 16003);
			add_location(tr, file, 461, 12, 15524);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(td0, "class", "border px-2 py-2");
			add_location(td0, file, 516, 12, 17871);
			attr_dev(td1, "class", "border px-2 py-2");
			add_location(td1, file, 517, 12, 17932);
			attr_dev(td2, "class", "border px-2 py-2");
			add_location(td2, file, 518, 12, 18004);
			attr_dev(td3, "class", "border px-2 py-2");
			add_location(td3, file, 519, 12, 18076);
			attr_dev(td4, "class", "border px-2 py-2");
			add_location(td4, file, 520, 12, 18156);
			attr_dev(td5, "class", "border px-2 py-2");
			add_location(td5, file, 521, 12, 18236);
			attr_dev(td6, "class", "border px-2 py-2");
			add_location(td6, file, 522, 12, 18311);
			add_location(tr, file, 515, 12, 17854);
		},
		m: function mount(target, anchor) {
			insert_dev(target, tr, anchor);
			append_dev(tr, td0);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 287, 8, 8077);
			attr_dev(div0, "class", "mb-6 shadow ");
			add_location(div0, file, 286, 4, 8042);
			...
			add_location(span3, file, 529, 48, 18512);
			attr_dev(div19, "class", "text-center");
			add_location(div19, file, 529, 0, 18464);
			attr_dev(caption7, "class", "text-center container mx-auto font-semibold mb-6 mt-8 text-xl italic text-blue-700");
			add_location(caption7, file, 534, 12, 18759);
			attr_dev(div20, "class", "mt-8  m-12  ");
			add_location(div20, file, 533, 4, 18720);
			attr_dev(div21, "class", "p-8");
			add_location(div21, file, 294, 0, 8460);
			attr_dev(div22, "class", "mb-20");
			add_location(div22, file, 285, 0, 8018);
			attr_dev(div23, "class", "bg-white text-blue-700");
