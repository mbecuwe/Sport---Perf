...
import Running_charts from './running-charts.72aa5a53.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			if (img.src !== (img_src_value = "running2.jpg")) attr_dev(img, "src", img_src_value);
