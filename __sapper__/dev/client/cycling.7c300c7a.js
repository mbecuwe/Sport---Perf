import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, F as validate_each_argument, v as validate_slots, e as element, t as text, f as claim_element, g as children, h as claim_text, b as detach_dev, k as add_location, l as insert_dev, m as append_dev, n as noop, a as space, c as claim_space, j as attr_dev, w as create_component, x as claim_component, y as mount_component, z as transition_in, A as transition_out, G as destroy_each, B as destroy_component } from './client.5ec075a0.js';
import './_commonjsHelpers.1e235def.js';
import './Chart.b2015135.js';
import Cycling_charts from './cycling-charts.0c3eab50.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(td0, file, 211, 12, 6074);
			attr_dev(td1, "class", "border px-4 py-2");
			add_location(td1, file, 212, 12, 6140);
			attr_dev(td2, "class", "border px-4 py-2");
			add_location(td2, file, 213, 12, 6197);
			attr_dev(td3, "class", "border px-4 py-2");
			add_location(td3, file, 214, 12, 6266);
			attr_dev(td4, "class", "border px-4 py-2");
			add_location(td4, file, 215, 12, 6359);
			add_location(tr, file, 210, 12, 6057);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(th4, file, 198, 12, 5678);
			attr_dev(th5, "class", "px-4 py-2");
			add_location(th5, file, 199, 12, 5722);
			attr_dev(th6, "class", "px-4 py-2");
			add_location(th6, file, 200, 12, 5774);
			attr_dev(th7, "class", "px-4 py-2");
			add_location(th7, file, 201, 12, 5824);
			attr_dev(th8, "class", "px-4 py-2");
			add_location(th8, file, 202, 12, 5876);
			add_location(tr4, file, 197, 12, 5661);
			add_location(thead1, file, 196, 8, 5641);
			add_location(tbody1, file, 207, 8, 5974);
			attr_dev(table1, "class", "table-auto text-center ");
			add_location(table1, file, 195, 8, 5593);
			attr_dev(div8, "class", "py-5");
			add_location(div8, file, 194, 4, 5566);
