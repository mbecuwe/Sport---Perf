import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, C as globals, e as element, a as space, t as text, f as claim_element, g as children, b as detach_dev, c as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, D as set_input_value, E as run_all, F as listen_dev, G as prevent_default, H as to_number, n as noop } from './client.6f1249ee.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			br8 = claim_element(div5_nodes, "BR", {});
		...
		h: function hydrate() {
			...
			add_location(label0, file, 127, 12, 4858);
			...
			add_location(input8, file, 180, 8, 7985);
			add_location(br7, file, 181, 12, 8202);
			...
			add_location(button, file, 183, 8, 8218);
			add_location(form, file, 120, 8, 4639);
			add_location(br8, file, 186, 12, 8450);
			attr_dev(div4, "id", "add_to_me");
			add_location(div4, file, 190, 8, 8468);
			attr_dev(div5, "class", " p-2");
			add_location(div5, file, 119, 4, 4612);
			attr_dev(div6, "class", "flex-initial w-2/3 p-2");
			add_location(div6, file, 115, 2, 4465);
			attr_dev(div7, "class", "flex ");
			add_location(div7, file, 107, 0, 4250);
		},
